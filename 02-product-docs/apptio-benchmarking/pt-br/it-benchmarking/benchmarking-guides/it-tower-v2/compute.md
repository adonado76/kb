...
| Midrange | Midrange abrange servidores proprietários que fornecem sistemas distribuídos substanciais (em plataformas como Unisys ou Tandem). O tema comum é uma arquitetura distribuída e a capacidade de oferecer suporte a vários clientes em paralelo. | iSeries (AS 400)  Servidores Tandem, DEC | MIPS configurado |
| Mainframe | Computadores mainframe tradicionais e operações que executam sistemas operacionais legados. | IBM mainframes executando MVS, VM, OS/390, zOS,zLinux.  Mainframes da Unisys | MIPS configurado |
