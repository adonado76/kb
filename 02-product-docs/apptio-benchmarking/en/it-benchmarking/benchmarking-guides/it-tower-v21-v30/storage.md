...
| IT Resource Sub Tower | Definitions | Examples | Unit Cost Unit of Measure (standard) (see [definition](#unit "(Opens in a new tab or window)") ) | FTE Efficiency Unit of Measure (see [definition](#fte "(Opens in a new tab or window)") ) |
| --- | --- | --- | --- | --- |
| Online | Online Storage resources attached to Servers. It excludes storage that is bundled (internal) in the server (it is included in the server cost). This includes Disaster Recovery storage. | SAN, NAS, iSCSI, CAS | Installed TB | Servers installed TB per FTE |
| Offline | Offline Storage resources attached to Servers. This includes Disaster Recovery storage. | Tape Backup Backup/Archival S/W | Installed TB | Servers Offline installed TB per FTE |
| Mainframe Online | Online Storage resources attached to Mainframes. This includes Disaster Recovery storage. | SAN, NAS, iSCSI, CAS | Installed TB | Mainframe installed TB per FTE |
| Mainframe Offline | Offline Storage resources attached to Mainframes. This includes Disaster Recovery storage. | Tape Backup  Backup/Archival S/W | Installed TB | Mainframe Offline installed TB per FTE |
