...
| --- | --- | --- | --- | --- |
| Servidores | Servidores físicos y virtuales que ejecutan una versión del sistema operativo Windows Server de Microsoft; incluye hardware, software, mano de obra y servicios de asistencia. | Servidor Windows 2k  Red Hat Servidor | Servidor lógico | Número de servidores lógicos por ETC para Servidor |
| Unix | Servidores que ejecutan sistemas operativos Unix propietarios específicos del proveedor; incluye hardware, software, mano de obra y servicios de asistencia. | IBM AIX  Sun Solaris | Servidor lógico | Número de servidores lógicos por ETC para Servidor |
| Gama media | La gama media abarca los servidores propietarios que proporcionan sistemas distribuidos sustanciales (en plataformas como Unisys o Tandem). El tema común es una arquitectura distribuida y la capacidad de dar soporte a múltiples clientes en paralelo. | iSeries (AS 400)  Tandem, servidores DEC | MIPS LPARS CPW configurado | Número de MIPS configurados por ETC para gama media |
| Sistema principal | Ordenadores centrales tradicionales y operaciones con sistemas operativos heredados. | IBM Mainframes que ejecutan MVS, VM, OS/390, zOS,zLinux.Unisysmainframes | MIPS configurado | Número de MIPS configurados por ETC para Mainframe |
