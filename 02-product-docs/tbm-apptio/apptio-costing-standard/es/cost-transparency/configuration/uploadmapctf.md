...
title: "Cargar y asignar los datos de la Fundación Costing Standard"
breadcrumb: []
...
summary: ""
---
# Cargar y asignar los datos de la Fundación Costing Standard

Tras instalar los componentes y configurar el tiempo para el proyecto, el siguiente paso es cargar los datos de Costing Standard Foundation en la aplicación y asignarlos a las tablas de datos maestros.
...
A continuación se describen paso a paso las instrucciones para cargar sus datos en cada una de las tablas de datos maestros:

- [Rellenar la tabla de datos maestros de fuentes de costes.](populatecostsource.html)
...
=Lookup(Cuenta,Mapa del Plan General de Contabilidad,Cuenta, {Fixed/Variable} )
