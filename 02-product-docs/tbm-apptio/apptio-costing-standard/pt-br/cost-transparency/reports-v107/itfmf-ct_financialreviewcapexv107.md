...
title: "Revisão financeira - relatório CapEx ( v107 )"
breadcrumb: []
...
- Rastreie os gastos de TI por CIO -1 em nível executivo, por proprietário do centro de custos e por pool de custos
...
Observação: O relatório **Financial Review - CapEx** requer a instalação do componente CTF - CapEx.
...
2. Na página **inicial**, clique em **IT Financials**. O relatório **Financial Review** é aberto.
3. Na guia de coleta de relatórios (elemento 1, abaixo), clique em **Financial Review - CapEx**.

Para planejamento:

1. Faça login em Apptio e navegue até **Planejamento > Costing Standard**.
2. Na página **inicial**, clique em **IT Financials**. O relatório **Revisão financeira** é aberto.
3. Na guia de coleta de relatórios (elemento 1, abaixo), clique em **Financial Review - CapEx**.
...
:   Esta coleção de relatórios fornece os detalhes financeiros de TI de que você precisa para analisar as variações de gastos e a precisão das previsões:
    ...
    - [Revisão financeira ( OpEx ) relatório ( v107 )](itfmf-ct_financialreview107.html)
...
:   Os KPIs fornecem uma visão de alto nível de seus gastos em CapEx :
    ...
    **CapEx** e **CapEx Orçamento**
    :   Esses dois KPIs mostram seu orçamento geral do CapEx em comparação com o CapEx do mês atual. A porcentagem de variação é mostrada à direita.

    **CapEx YTD** e **CapEx Orçamento YTD**
    :   Esses dois KPIs mostram suas despesas em CapEx em comparação com o orçamento YTD. A porcentagem de variação é mostrada à direita.

    **CapEx anual** e **orçamento anual CapEx**
    :   Esses dois KPIs mostram suas despesas anuais em CapEx e o orçamento YTD. A porcentagem de variação é mostrada à direita.
