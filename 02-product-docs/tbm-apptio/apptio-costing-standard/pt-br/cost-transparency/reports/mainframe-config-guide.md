...
title: "Guia de configuração do TCO do mainframe"
breadcrumb:
  - "Costing Standard"
...
summary: ""
---
# Guia de configuração do TCO do mainframe
...
1. Carregue os dados recebidos da ferramenta Intellimagic como arquivo de entrada na categoria " **Mainframes** ". Crie uma coluna ' **Ponderação** ' usando uma fórmula personalizada.
   ...
   - Você tem a flexibilidade de alterar a fórmula com base na preferência de peso da MSU. Aqui, a ponderação é baseada na soma de 100% do consumo de MSU de GCP e 30% do consumo de MSU de zIIP.
...
8. GCP Alocação de MSU para o mainframe.
   - Em “Modelo”, selecione a métrica “ GCP ” (MSU) e, em seguida, clique em “**Adicionar driver de unidade** ”

     ![Adicionar driver de unidade](../../../../../03-media/apptio-costing-standard/resources/images/ct_images/add-unit-driver.png)
   - Use a coluna **“CPU d GCP ” (Consumo de MSU)** para preencher o driver e nomeie-o como “**Driver de Unidade MSU d GCP** ”.

     ![GCP MSU](../../../../../03-media/apptio-costing-standard/resources/images/ct_images/gcp-msu.png)
   - Selecione “**Salvar** e confirmar” as alterações para inserir os dados de um MSU d GCP no objeto Mainframes.

     ![Salvar alterações](../../../../../03-media/apptio-costing-standard/resources/images/ct_images/save-gcp-msu.png)

   Observação: As MSUs GCP são controladores de unidade específicos para o objeto Mainframes e devem ser alocadas exclusivamente a partir do Mainframe. Essa alocação deve ser removida manualmente se houver alocação de qualquer outro objeto.
...
10. Alocação de custos do mainframe para o aplicativo.
    - Selecione “Custo métrico” e, em seguida, selecione as métricas “ GCP ” e “ zIIP ”.
...
- **Análise de mainframe**
  ...
  - Visualize o consumo de recursos do MSU em GCP e zIIP e compare diferentes tipos de processamento de cargas de trabalho.
