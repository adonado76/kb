...
practice: "tbm"
language: "en"
doc_type: "configuration-additional"
title: "About upgrading Costing Standard"
breadcrumb: []
source_path: "configuration-additional/aboutupgradingct.html"
images: []
capability_ids: []
...
To see the version of TBM Studio you are running, select ![](../../resources/images/ap_images/ui-tbar-settings.png) > About.
...
that supports that template. For example, you can't access Template v106 unless you are on TBM
Studio 12.6 and later.
