...
- At an executive level, track IT spend per CIO -1 by cost center owner and cost
- Analyze transaction details to understand variance plan drivers
...
:   This report collection provides the IT financial details you need to review your spend variances
    ...
    - [Financial Review - CapEx report (v107)](itfmf-ct_financialreviewcapexv107.html)
...
:   KPIs provide a high-level view of your OpEx spend:
    ...
    **OpEx YTD** and **OpEx Budget**
    :   These two KPIs show your overall OpEx budget compared to the OpEx spend for the current month.
        The percentage of variance is shown to the right.

    **OpEx YTD** and **OpEx Budget YTD**
    :   These two KPIs show your OpEx spend compared to the budget YTD. The percentage of variance is
        shown to the right.

    **Annual OpEx** and **Annual OpEx Budget**
    :   These two KPIs show your annual OpEx spend compared to the FY budget. The percentage of variance
        is shown to the right.

    **% OpEx Variable YTD** and **% OpEx Fixed YTD**
    :   These KPIs help you determine the agility of your IT spend by looking at the ratio of fixed and
        variable expenditures for the fiscal year.
...
:   The email icon is visible only to financial analysts with admin permissions. Click the icon to
    open the **Finance Variance Review** email report. See the [Finance Variance Review email report](../reports-v104/itfmf-ct_financialvariancereviewemail104.html).
