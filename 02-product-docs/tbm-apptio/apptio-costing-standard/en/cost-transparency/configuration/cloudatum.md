...
as being Public Cloud, so you will need to update that list to include subtowers with Public Cloud.
...
:   1. In the Formulas section, change Is Cloud to Public Cloud=Yes, since the public cloud report
    ...
    2. Append in the Public Cloud flag to the metadata field in the IT Resource Tower Master Data. This
       separates non-cloud costs from cloud costs.![](../../../../../03-media/apptio-costing-standard/resources/images/ct_images/7988_4.png)
