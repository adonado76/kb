...
breadcrumb: []
source_path: "cost-transparency/configuration/aws.html"
images: []
capability_ids: []
...
To configure the application for Amazon Web Services, you must install the CTF-Cloud Service and
CTF-Amazon Web Services components.
