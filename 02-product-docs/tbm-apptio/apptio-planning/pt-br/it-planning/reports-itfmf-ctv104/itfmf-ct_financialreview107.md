...
Standard em TBM Studio 12.3 e posterior, com o modelo v107 e posterior

Casos de uso

- Acompanhe os gastos de TI por CIO-1 em nível executivo, por proprietário de centro de custos e por custo
...
![imagem](../../../../../03-media/apptio-planning/resources/images/it_planning_images/itfmf-ct_images/itfmf-ct_financialreview_opex.jpg)
...
- [Revisão financeira - CapEx ( v107 )](itfmf-ct_financialreviewcapexv107.html)
...
- OpEx YTD e OpEx Budget - Esses dois KPIs mostram seu orçamento geral de OpEx em comparação com o gasto de OpEx no mês atual. A porcentagem de variação é mostrada à direita.
- OpEx YTD e OpEx Budget YTD - esses dois KPIs mostram suas despesas em OpEx em comparação com o orçamento YTD. A porcentagem de variação é mostrada à direita.
- Annual OpEx e OpEx Budget YTD - Esses dois KPIs mostram suas despesas em OpEx em comparação com o orçamento YTD. A porcentagem de variação é mostrada à direita.
- % OpEx Variable YTD e % OpEx Fixed YTD - Esses KPIs ajudam você a determinar a agilidade de seus gastos com TI, observando a proporção de gastos fixos e variáveis para o ano fiscal.
...
![imagem](../../../../../03-media/apptio-planning/resources/images/it_planning_images/itfmf-ct_images/itfmf-ct_financialreview_viewby.jpg)
...
![imagem](../../../../../03-media/apptio-planning/resources/images/it_planning_images/itfmf-ct_images/itfmf-ct_financialreview_variancedetail.jpg)
...
![imagem](../../../../../03-media/apptio-planning/resources/images/it_planning_images/itfmf-ct_images/itfmf-ct_financialreview_transactiondetail.jpg)
...
![imagem](../../../../../03-media/apptio-planning/resources/images/it_planning_images/itfmf-ct_images/itfmf-ct_financialreview_spendanalysis.jpg)
