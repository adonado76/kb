...
breadcrumb: []
source_path: "release-notes/whats-new-2021.html"
images: []
capability_ids: []
...
[Learn
more about the Change history](Learn%0Amore about the Change history../../it-planning/planning/change-history.dita "(Opens in a new tab or window)")
...
[Learn
more about the Event Log](Learn%0Amore about the Event Log../../it-planning/planning/change-history.dita "(Opens in a new tab or window)")
...
[Learn
more about the Plans page](Learn%0Amore about the Plans page../../it-planning/planning/manage-plans.dita "(Opens in a new tab or window)")
...
[Learn more about group actions](Learn more about group actions../../it-planning/planning/review-approve-return.dita "(Opens in a new tab or window)")
...
[Learn
more about Line Item Codes](Learn%0Amore about Line Item Codes../../it-planning/planning/line-item-codes.dita "(Opens in a new tab or window)")
...
[View
and export the change history](View%0Aand export the change history../../it-planning/planning/change-history.dita "(Opens in a new tab or window)")
...
For more information, see [Labor Configuration reference data](Labor Configuration reference data../../it-planning/planning/manage-labor-configuration.dita#Manage "(Opens in a new tab or window)").
...
1. In the left-hand navigation menu, select Configuration>Line Item
   ...
   add a new filter, select ![](../../resources/planning_images/icon-itp-apex-add-filter_20x20.png). For
   more information, see [Line Item Filters](Line Item Filters../../it-planning/planning/itp-dependent-picklists.dita "(Opens in a new tab or window)").
...
For more information, see [Plan for decreasing asset values with Depreciation Methods](Plan for decreasing asset values with Depreciation Methods../../it-planning/planning/depreciation-method.dita "(Opens in a new tab or window)")
...
comments](Learn more about using%0Acomments../../cnc/using-comments.dita "(Opens in a new tab or window)").
...
In addition to import locations across Planning, this feature is also available on the Costing
Standard Integration page. It functions identically as shown previously. The image below is an
