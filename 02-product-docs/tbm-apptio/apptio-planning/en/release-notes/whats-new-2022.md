...
breadcrumb: []
source_path: "release-notes/whats-new-2022.html"
images: []
capability_ids: []
...
For more information on enabling the New Expenses View, see [Enable Apex Line Item Table](../../it-planning/planning/enable-apex-line-item-table.dita "(Opens in a new tab or window)").
...
![](../../resources/images/it%20planning_images/release-notes/kpis_1.png)

The section can be expanded to get a detailed view, by selecting the expand icon to the left of
the KPIs displayed.

![](../../resources/images/it%20planning_images/release-notes/kpis_2.png)

## 3.34 - November 28, 2022

Starting on Monday 11/28/2022, main production tenants begin to upgrade to release 3.34. This
minor release announces the general availability of Integrated Investment Planning, an
additional capability of ApptioOne Planning.
...
For detailed information on Integrated Investment Planning, see [Get started with the Integrated Investment Planning](../../it-planning/planning/iip/gs-integrated-investment-planning.dita "(Opens in a new tab or window)").
...
[Allocate Labor to Project using Role or Name](../../it-planning/planning/iip/allocate-labor-project.dita "(Opens in a new tab or window)")
...
![](../../resources/images/it%20planning_images/classic-view-old-page-header.png)

## Classic View - new page header

![](../../resources/images/it%20planning_images/classic-view-new-page-header.png)

## New View - old page header

![](../../resources/images/it%20planning_images/new-view-old-page-header.png)

## New View - new page header

![](../../resources/images/it%20planning_images/new-view-new-page-header.png)

To learn more about the New View please see [Enable Apex Line Item Table](../../it-planning/planning/enable-apex-line-item-table.dita "(Opens in a new tab or window)")
...
Cost Transparency. For more information, see [Working with Cost Transparency Integration Panel](../../it-planning/planning/cti_panel.dital "(Opens in a new tab or window)"). However, importing data
...
needs to know that changes have taken place in the reference data on the Cost Transparency side, and
there is a wait time for the Cost Transparency calculations to complete. Hence, the calculation
queue should be actively monitored to finish before the data can be pulled into planning. Once the
data is ready, the planning administrator has to manually click buttons on the Cost Transparency
Integration page in Planning and resolve any conflicts due to dependencies between dimensions, as
described in the [Reference Table Dependencies Diagram](https://community.apptio.com/docs/DOC-9956#Reference%20Table%20Dependencies%20Diagram "(Opens in a new tab or window)"). Manually pulling
reference data from Cost Transparency can become time consuming and a painful process to debug and
...
[Working with Apex line items](../../it-planning/planning/working-with-apex-line-items.dita "(Opens in a new tab or window)")

## 3.24 - July 11, 2022

Starting on Monday 07/11/2022, main production tenants begin to upgrade to release 3.24. This
release adds Rename Standard Dimension and Publish Labor Activity Plan Data to Costing
Standard for Integrated Investment Planning.

## Rename Standard Dimensions

You can now rename the following project-related dimensions in Integrated Investment
Planning:
...
For more information, see [Rename project-related standard dimensions](../../it-planning/planning/rename_dimension.dita "(Opens in a new tab or window)")

## Publish Labor Activity Plan Data To Costing Standard

Labor Activity plan data in Integrated Investment Planning can now be published to Costing
Standard.
...
1. Navigate to ![](../../resources/images/icons/icon-settings.png) > Cost Transparency Integration > Publish.
2. Select the plan from the drop-down menu.
3. Select the Labor Activity Line Item Type.
4. Select Publish.

For more information, see [Working with Costing Standard Integration Panel](../../it-planning/planning/cti_panel.dital "(Opens in a new tab or window)")
...
For more information, see [Compare versions or plans](../../it-planning/planning/compare-versions-plans.dita "(Opens in a new tab or window)")
...
For more information, see [Enable Apex Line Item Table](../../it-planning/planning/enable-apex-line-item-table.dita "(Opens in a new tab or window)")
...
For more information, see [Asset Depreciation Cost Center](../../it-planning/planning/iip/asset-depreciation-cost-center.dita "(Opens in a new tab or window)")
...
For more information about change history, see [View and export the change history.](../../it-planning/planning/change-history.dita "(Opens in a new tab or window)")
...
For more information about Integrated Investment Planning, see [Get started with Integrated Investment Planning](../../it-planning/planning/iip/gs-integrated-investment-planning.dita "(Opens in a new tab or window)")
...
- Added the Configure Variance Analysis button, under Planning > Variance
  Analysis and Forecast plan > Dashboard.

  ![](../../resources/images/it%20planning_images/release-notes/itp-316-configure-variance-anaysis.png)

  ![](../../resources/images/it%20planning_images/release-notes/itp-316-configure-variance-analysis-dashboard.png)
...
- In Configuration > Reference Data, we moved the Cost Transparency
  Integration feature from Options (![](../../resources/images/icons/icon-options_23x20.png)) to Settings (![](../../resources/images/icons/icon-settings_20x20.png)).

  [Find your way around Planning and Planning](../../it-planning/planning/navigate-apptio-planning.dita "(Opens in a new tab or window)")
- The plan menu now has a plan status and plan type details.

  ![](../../resources/images/it%20planning_images/itp_plan_status_details.png)
...
![](../../resources/images/it%20planning_images/ref-data.png)
...
- To navigate back to the Reference Data page, select Back (![](../../resources/images/icons/icon-back_18x20.png)) in the top left corner
  of the screen.
