...
breadcrumb: []
source_path: "planning/faq-ct-integration-panel.html"
images: []
capability_ids: []
...
panel provides centralized management and one-click import and export with Costing
Standard.
...
functionality, from the Settings menu, click Cost Transparency
Integration.
...
see: [Reference Table Dependencies Diagram](https://community.apptio.com/docs/DOC-9956 "(Opens in a new tab or window)").
...
Transparency Integration Panel](cti_panel.html "(Opens in a new tab or window)").
