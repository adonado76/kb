...
breadcrumb: []
source_path: "planning/customize-save-share-apx.html"
images: []
capability_ids: []
...
1. Navigate to **Planning** > **Expenses** from the left navigation menu.
...
:   1. Customize the table layout as per the requirements, by following instructions from the previous
       section.
    2. Select ![](../../resources/images/it%20planning_images/layout-icon_28x20.png) from
       the Expenses Table menu.
...
Rename Layout
:   1. Select ![](../../resources/images/it%20planning_images/layout-icon_28x20.png) from
       the Expenses Table menu.
    2. In the My Layouts menu, select the pencil icon for the layout you want to rename.

       ![](../../resources/images/it%20planning_images/tl-edit.png)
    3. The Rename Layout popup appears.

       ![](../../resources/images/it%20planning_images/tl-edit-1.png)
...
:   1. To customize a layout, select the layout you want to change.
    2. Make the required changes and then select **Save**. A confirmation message "*Success: Save
       ...
       ![](../../resources/images/it%20planning_images/tl-edit-2.png)
...
:   Note: This option is available only for Public Layouts. The **Clone** icon remains disabled until
    ...
    2. In the **Public Layouts** menu, select the 'Default Layout' and select the **Clone**
       ![](../../resources/images/it%20planning_images/tl-cln-icon_20x20.png)icon.

       ![](../../resources/images/it%20planning_images/tl-clone.png)
    3. The Copy Layout popup appears. Enter a name for the layout and select **Save**.

       ![](../../resources/images/it%20planning_images/tl-copy.png)
    4. The cloned layout is added to My Layouts section, as shown.

       ![](../../resources/images/it%20planning_images/tl-cln-1.png)
...
2. In the My Layouts menu, select the **Delete** icon for the layout you want to
   ...
   ![](../../resources/images/it%20planning_images/tl-del.png)
...
- To reset the complete layout, select the **Reset columns to default layout** option from the
  ![](../../resources/images/it%20planning_images/layout-icon_28x20.png) menu.

  ![](../../resources/images/it%20planning_images/tl-reset-default.png)
- To undo the changes made in a particular layout (before saving it), select the ![](../../resources/images/it%20planning_images/tl-reset-icon_26x22.png) icon for that
  layout.

  ![](../../resources/images/it%20planning_images/tl-reset.png)

  An error
  message appears as shown. Select **Okay** to continue with the reset.

  ![](../../resources/images/it%20planning_images/tl-rst-error.png)
...
2. From the dropdown, select the **Layout Access** option. The following popup appears.
   ...
   ![](../../resources/images/it%20planning_images/tl-access.png)
3. Switch the toggle for the layout that needs to be made **Public** and then select
   **Apply**.

   ![](../../resources/images/it%20planning_images/tl-toggle.png)
4. The selected layout is removed from **My Layouts** section and will appear in the **Public
   ...
   ![](../../resources/images/it%20planning_images/tl-publay.png)

   To make the layout as
   private or delete a public layout, switch the toggle again and then select **Apply**.
