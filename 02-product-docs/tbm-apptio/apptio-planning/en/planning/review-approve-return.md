...
breadcrumb: []
source_path: "planning/review-approve-return.html"
images: []
capability_ids: []
...
immediately visible on the All Plan Sections pages. See [Edit the Company Profile](edit-company-profile.dita "(Opens in a new tab or window)") and [Submit a plan or forecast](submit-plan-forecast.dita "(Opens in a new tab or window)") for
...
reference data](manage-cost-object.dita "(Opens in a new tab or window)") for more information. The Cost Object Permissions edit levels include the
following:
...
2. Navigate to Planning > Status. Select Include View-Only Cost Objects to include Cost
   Objects with view-only permissions.

   Note: The Enforce View Permissions option must be enabled. See
   [Edit the Company
   ...
   - Actions column - In the Status view, in the Actions column, in a row of a cost object or a group
     ...
     [Read
     more about how certain actions affect leaf and group cost objects](#ReviewapproveorreturnplansorCostObjects__ApprovalHierarchyActions)
...
plans](compare-versions-plans.dita "(Opens in a new tab or window)")
...
3. In the top-right corner, in the section menu, select a cost object category.
   ...
   ![](../../resources/images/it%20planning_images/cost-object-category.png)
4. In the top-right corner, in the sub-section menu, select a cost object.

   ![](../../resources/images/it%20planning_images/cost_object_sub-section.png)
5. Select a line-item table view.

   ![](../../resources/images/it%20planning_images/line-item_table_view.png)
6. From the snapshot dropdown, select Save Snapshot.

   ![](../../resources/images/it%20planning_images/snapshot_save.png)
...
5. Select the snapshot dropdown.
   ...
   ![](../../resources/images/it%20planning_images/snapshot_dropdown.png)
