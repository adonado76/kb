...
breadcrumb: []
source_path: "planning/pfp/score-manage.html"
images: []
capability_ids: []
...
Auto-Scoring** option has been enabled. See [Edit the Company Profile](../edit-company-profile.htm "(Opens in a new tab or window)"). The Score value is calculated using the Score data
