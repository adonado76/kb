...
breadcrumb: []
source_path: "planning/iip/integrated-iip.html"
images: []
capability_ids: []
...
costs, you can follow the existing documentation to Manage direct costs. Integrated Investment
Planning introduces below changes in the process.
...
- Every expense type has Cost Type attribute which can be set to either Run or Build. If the
  ...
  ![](../../../resources/images/it%20planning_images/itp-project-column.png)

  For more details about Labor planning and allocation, see [Labor Resource
  Planning](labor-resource-planning.htm "(Opens in a new tab or window)").
