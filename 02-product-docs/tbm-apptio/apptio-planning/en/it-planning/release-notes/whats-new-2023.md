...
- Automated Data Management : The connection settings are configured
  automatically when ADM integration is enabled from Company Profile. For more information, see [Prerequisites](../planning/adm/adm_prerequisites.html).
- Expense Line Delete Confirmation - A confirmation dialog will be shown
  before deleting an expense line item. This feature is available from
  Expenses > New View. To know more, see
  [Deleting line
  items](../planning/working-with-apex-line-items.html "This topic explains how to manage Apex line items in the application, including adding, inserting, duplicating, importing, exporting, and deleting line items.").
...
know more, see [Compare labor headcount](../planning/analyze-labor-headcount.html)
...
in addition to Hours as currently supported unit of quantity. To know more, see [FTE labor activity data](../planning/ssr/fte-labor-activity-data.html "Currently, the data available in the Apptio BI supports only hours data, but for IIP the Labor Activity planning is enabled using both Hours and FTE unit. This feature allows the users to create allocation reports using FTE so that they can analyze the allocation report using the capacity, utilization details and monthly allocation data per resource.").
...
Data Management Integration, see [ADM Overview.](../planning/adm/adm_overview.html "Costing & Planning is integrated with the Automated Data Management platform service that enables automated sharing of data from Costing & Planning Cost (Costing Standard) to Costing & Planning Plan ( Planning), and brings in the ability to import plan data on-demand from Costing Standard to a specific plan.")

To learn more about importing actuals with Automated Data Management please visit [Import
Actuals](../planning/adm/adm_import_actuals.html "Importing Actuals brings historical spend data from Apptio Costing into Apptio Planning, where it can be used for forecasting, variance analysis, and plan comparisons.").
...
![image](../../resources/images/it%20planning_images/proj-list-data.png)

To learn more visit [Upgrade Reference Data](../planning/iip/project-list-document.html) in Plan section.
...
![image](../../resources/images/it%20planning_images/pg-projects.png)
...
![image](../../resources/images/it%20planning_images/3.54-labor.png)
...
![image](../../resources/images/it%20planning_images/release-notes/3.53-rn_987x238.png)
...
versions or plans](../planning/compare-versions-plans.html "You can compare the financial data between two periods or versions of the same plan or between two different plans. These comparisons surface differences across time periods and line items to help you understand changes and variances.")
...
► Learn about: [Manage Plans](../planning/manage-plans.html "With the Plans page, you can manage your plans easily and intuitively.")
...
► Learn about:[Project Level Access Control](../planning/iip/project-level-access-control.html)
...
► Learn about: [Async Plan Creation](../planning/create-budget-plan.html)
...
Overview](../planning/adm/adm_overview.html "Costing & Planning is integrated with the Automated Data Management platform service that enables automated sharing of data from Costing & Planning Cost (Costing Standard) to Costing & Planning Plan ( Planning), and brings in the ability to import plan data on-demand from Costing Standard to a specific plan.").
...
► Learn about: [Custom Dimension Entity Mapping](../planning/adm/custom-dimension-entitiy-metric.html)
...
periods. For more details, visit [Custom Date Ranges](../planning/ssr/custom-date-ranges.html "The Costing & Planning customers can now create multi-year reports using custom date ranges.").
...
![image](../../resources/images/it%20planning_images/release-notes/esdh-example.png)
...
![image](../../resources/images/it%20planning_images/release-notes/esdh-prev.png)

## New behavior (After ApptioOne Plan 3.43 release)

![image](../../resources/images/it%20planning_images/release-notes/esdh-current.png)
...
![image](../../resources/images/it%20planning_images/project-list.png)

![image](../../resources/images/it%20planning_images/project-list-view.png)

► Learn about: [Project List](../planning/iip/project-list-document.html)
...
Customers using [Integrated Investment Planning](../planning/iip/gs-integrated-investment-planning.html) can now enable or disable Labor Activity tab
...
To enable “New View” in Expenses, see [Enable Apex Line Item Table.](../planning/enable-apex-line-item-table.html)
