...
title: "Cost Transparency Integration (Legacy)"
breadcrumb:
  - "Planning"
  - "Integrations"
...
summary: ""
---
# Cost Transparency Integration (Legacy)
...
- Publish budget plans and forecasts from your Apptio Planning application to Costing Standard
...
:   This method determines the Costing Standard instance and project domain
    from the environment settings. The Enhanced Access Administration
    environment and the authentication token for the user are included in the request.
...
1. On the Apptio Planning menu, select **Settings** then select **Cost Transparency Integration**.
...
3. In General, enter the following:
   ...
   :   Select any of the following:
       ...
       - **Reference Data**: enable importing of default and custom dimensions, such as Cost Centers
         ...
         reference data sets in the Planning Costing Standard section match what was uploaded to Costing Standard.
       - **Export Settings** - Configure **Export Settings** to define default
         export behavior for all plan datasets. Export settings let you control how plan
         data is published, including selecting the export format, choosing the default
         or original currency, defining date format and decimal precision, applying
         sensitive data filters, and configuring whether months are published as rows or
         columns (edited)
4. Select Save.
