...
title: "Import Projects List from Apptio Costing"
breadcrumb:
  - "Planning"
  - "Integrations"
...
summary: ""
---
# Import Projects List from Apptio Costing
...
The plan-level Projects List can be imported using Automated Data Management (ADM), ensuring
project data stays aligned across applications.
...
to the Apptio Costing datasets.

1. Go to **Settings (⚙) → Automated Data Management**
2. Navigate to **Entity Management**.
3. Locate the **Import Plan Project List** entity in the Entity table.
...
To import projects into a plan:

1. Navigate to **Plan > Projects List**.
2. Select the **overflow menu (⋯)**.
3. Choose **Import from Apptio Costing**.
4. Choose how the data should be applied:
   ...
   Note: **Update Data** method is supported only when the **External Code** feature
   is enabled.
5. Select the **Apptio Costing period** you want to import data from.
6. Click **Import**.
