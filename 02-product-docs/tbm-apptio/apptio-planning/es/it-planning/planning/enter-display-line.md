...
title: "Trabajar con distintas monedas"
breadcrumb:
  - "Planning"
  - "Trabajar con planos"
...
2. Abra el **menú Elipses** y elija:
   1. **Exportar plantilla** para descargar una plantilla en blanco o
...
Puede definir una divisa por defecto para cada departamento con el fin de garantizar que la introducción de datos se ajusta a los requisitos financieros locales o regionales.
