...
title: "Importar datos reales desde Apptio Cálculo de costes"
breadcrumb:
  - "Planning"
  - "Integraciones"
...
summary: ""
---
# Importar datos reales desde Apptio Cálculo de costes

La importación de datos reales transfiere los datos históricos de gastos desde Apptio Costing a Apptio Planning, donde pueden utilizarse para realizar previsiones, análisis de variaciones y comparaciones de planes.

Los datos reales se importan mediante Automated Data Management (ADM), lo que garantiza que los datos de gasto real se mantengan alineados en todas las aplicaciones.
...
3. Localice la entidad **Actuals** en la tabla Entity.
4. Asigne el **conjunto de datos de costes Apptio** correspondiente a la entidad. Por ejemplo, maestro de datos reales de planificación.
...
## Importar datos reales a Apptio la planificación
...
1. Un usuario actualiza los conjuntos de datos asignados a la entidad «Datos reales» y realiza un registro en Apptio «Cálculo de costes» ( Data Studio ).
...
4. ADM recupera los datos reales actualizados del entorno de preparación de costes y los importa para su uso en Apptio Planificación.
5. Las actualizaciones de los datos de referencia se aplican en primer lugar.
6. Los datos reales se importan a Apptio Planificación para los períodos fiscales correspondientes.

Nota: Si los periodos están marcados como **Cerrados** en Gestión de gastos, la Gestión de gastos automatizada Data Management (ADM) no actualizará los datos de esos periodos.
...
- La importación de datos reales se completa sin necesidad de publicación manual
