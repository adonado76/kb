...
breadcrumb: []
source_path: "studio/report-studio/visualizations/rs-stacked-column.html"
images:
  - "resources/images/studio_images/rs-samplstkcol.png"
  - "resources/images/studio_images/rs-stkdcol.png"
capability_ids: []
...
Para crear un gráfico de columnas,

1. Abra un informe nuevo o existente.
2. Vaya a **Visualizaciones** y seleccione el mosaico **Columna**.

   ![azulejo de columna apilada](../../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/rs-stkdcol.png)
3. Haga clic en el componente Columna apilada para activar los paneles **Datos** y **Formato**.
4. Despliegue los paneles para configurar los datos y las opciones de formato:
   ...
   | Leyenda | Arrastre o añada un dato de leyenda |
   | Eje Y | Arrastre o añada los datos para el eje Y |
   | Eje X | Arrastre o añada los datos para el eje Y |
   | Filtros | Arrastre o añada los criterios de filtrado |
   | **Formato - Propiedades** | |
   | Eje X | Edite las siguientes propiedades, según sea necesario - Mostrar el título del eje X - Mostrar los valores del eje X - Tamaño y estilo de letra (negrita, cursiva, subrayado) - Color del texto del título y los valores del eje X (con opción para restablecer el color) - Conmutar la posición del eje X - Mostrar las líneas de la cuadrícula del eje X |
...
Aquí se muestra un ejemplo de gráfico de columnas.

![muestra de columna apilada](../../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/rs-samplstkcol.png)
