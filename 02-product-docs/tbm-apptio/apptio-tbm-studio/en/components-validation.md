...
breadcrumb:
  ...
  - "Validation"
source_path: "SSWRJM/studio/new-uc/reference/report-studio-reference/validation.html"
images: []
capability_ids: []
...
Property: Value Required - When checked, users cannot save the table if a row has an empty value in this column.
...
Property: Allow Unique Values only - When checked, users cannot save the table if the column contains duplicate values.
...
- Total Row Validator: Validates that column totals meet requirements (e.g., percentages summing to 100%)
