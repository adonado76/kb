...
breadcrumb: []
source_path: "data_studio/enter-data-manually.html"
images: []
capability_ids: []
...
function](../formulas-and-functions/functions/tablematch.dita "(Opens in a new tab or window)") or similar would be a better choice. While there are valid use cases for enriched
...
Note: You may also wish to see [Table Upload component](../reports/table-report-upload-component.dita "(Opens in a new tab or window)") to familiarize yourselves with that
