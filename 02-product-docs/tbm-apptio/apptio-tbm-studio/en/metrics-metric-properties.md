...
breadcrumb:
  ...
  - "Model Metrics"
  - "Metric Properties"
source_path: "SSWRJM/studio/new-uc/reference/model-studio-reference/metric-properties.html"
images: []
capability_ids: []
...
Each metric has configurable properties that control its behavior. Properties marked with (*) apply to calculated metrics only.
