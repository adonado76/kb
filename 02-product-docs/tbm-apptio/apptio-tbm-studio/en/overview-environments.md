...
breadcrumb:
  ...
  - "UI Overview"
  - "Environments"
source_path: "SSWRJM/studio/new-uc/getting-started/environments.html"
images: []
capability_ids: []
...
- You can view other users’ Development environments if you have appropriate permissions
...
To switch environments: Use the Environment dropdown in the toolbar and select Development, Staging, or Production.
