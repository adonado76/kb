...
breadcrumb: []
source_path: "model_studio/weighted-value-allocations.html"
images: []
capability_ids: []
...
Watch this demo video from Apptio Education Services: [Weight by Other - TBM
Studio R12.5 New Functionality](https://community.apptio.com/videos/2114 "(Opens in a new tab or window)"). Or, browse [all Apptio
...
allocations ([Learn
more](allocate-value-in-model.htm "(Opens in a new tab or window)")). For example, you might distribute the allocation based on the number of employees in a
...
- Weight by negative: If you try to weight an allocation by a negative value, the
  ...
  negative numbers](about-weighting-and-negative-numbers.htm "(Opens in a new tab or window)").
