...
breadcrumb: []
source_path: "reports/filter-slicers.html"
images: []
capability_ids: []
...
2. Right-click on the field and select Edit Filter from the pop-up menu. The **Edit
   Filter** dialog is displayed as shown in the following image:![](../../resources/images/studio_images/studioimages/reports/rep143.png)
