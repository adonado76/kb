...
breadcrumb: []
source_path: "reports/table-report-upload-component.html"
images: []
capability_ids: []
...
[Learn more about the Enable Features option.](../admin/enable_features.htm "(Opens in a new tab or window)")
...
4. ![](../../resources/images/studio_images/studioimages/reports/table-upload-component-2.png)
...
8. ![](../../resources/images/studio_images/studioimages/reports/table-upload-component-3.png)
...
generated table. To see this button, enable the Enable/Disable Upload option in the [Advanced Properties](tables/set-table-properties.htm "(Opens in a new tab or window)")
popup.
