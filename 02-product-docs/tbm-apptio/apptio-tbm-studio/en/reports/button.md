...
breadcrumb: []
source_path: "reports/button.html"
images: []
capability_ids: []
...
1. In the upper-left corner of the button component, click the small triangle ![](../../resources/images/studio_images/studioimages/icons/arrow-down-greyicon.png) to open the
   Actions menu, and the click Properties. The Properties dialog box
   appears:![](../../resources/images/studio_images/studioimages/reports/rep147.png)
2. Use the fields on the Button tab to change the appearance of the button. The fields are
   ...
   - Button Text - Text entered in this field is displayed in the button. Usually, this will
     ...
     see [HTML text box](html.htm "(Opens in a new tab or window)").You can also replace or
...
1. In the Properties dialog, select the Actions tab
   in the header. The application displays the following fields:![](../../resources/images/studio_images/studioimages/reports/rep148.png)
2. Complete the fields.
   ...
   - Navigate - Enter a link to a document using Wiki-style syntax. See [Coding Links to Other
     Reports](coding-links-to-other-reports.htm "(Opens in a new tab or window)") for details and examples.
...
- Data URL - Displays the path to the table that supplies the data for the
  ...
  Path icon ![](../../resources/images/studio_images/studioimages/icons/edit_21x21_icon.png) to the right of
