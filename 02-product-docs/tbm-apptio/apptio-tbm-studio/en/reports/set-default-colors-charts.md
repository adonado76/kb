...
breadcrumb: []
source_path: "reports/set-default-colors-charts.html"
images: []
capability_ids: []
...
| blue |  | purple |  | black |  |
| red |  | lightblue |  | gray |  |
| green |  | pink |  | lightgray |  |
| yellow |  | teal |  | darkgray |  |
| violet |  | crimson |  | white |  |
| brown |  | orange |  |  |  |
| skyblue |  | darkblue |  |  |  |
...
To know more, refer [Custom Color Palette](../admin/color-enhancement.htm "(Opens in a new tab or window)").
