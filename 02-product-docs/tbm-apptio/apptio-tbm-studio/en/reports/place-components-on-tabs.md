...
breadcrumb: []
source_path: "reports/place-components-on-tabs.html"
images: []
capability_ids: []
...
- In the upper-left corner of the tabbed group, click the small triangle ![](../../resources/images/studio_images/studioimages/icons/arrow-down-greyicon.png) next to the
  component name to display the Actions menu. From the Actions menu, click
  Properties.
