...
those changes with the original project. Branching is an extremely powerful addition to the TBM Studio experience, and it is important to understand its intended uses.

![image](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/studioimages/studio_diagram_branching.png)
...
- Closing a branch removes the branch project along with any build projects, workspaces, and so
  ...
  trunk is promoted to Production, the branch may be closed. See also [Troubleshoot a branched project that cannot be closed](https://community.ibm.com/community/user/viewdocument/troubleshoot-a-branched-project-tha "(Opens in a new tab or window)").
...
performance, see [Managing performance in your development environment](https://community.ibm.com/community/user/viewdocument/manage-performance-in-your-developm?CommunityKey=44bcb0d2-5ce6-4504-89eb-019253d3b5d8&tab=librarydocuments "(Opens in a new tab or window)").
...
![image](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/studio-calculation-queue_sui_1.jpg)

TBMAs wanting to navigate to this view should navigate to Enhanced Access
Administration, select the **TBM Studio** tile, and then open the
**Calculation Queue**.
...
![image](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/studio_tag_project.png)
...
1. Navigate to the branch.
   ...
   ![image](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/ac-1.jpg)
2. Update the column value IT to IT Extension and **Save** the changes.

   ![image](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/ac-2.jpg)
3. The **Check in** button is enabled and the underlying editable table is checked out.

   ![image](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/ac-3.jpg)
...
2. Right-click the tag, and then select **Create branch from this point**.
   ...
   ![image](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/studio-create-branch-from-tag_sui.jpg)
...
2. Right-click the Check In History tab at the bottom and select Verbose View. When you are in
   Verbose View, you can see all the default builds without custom tags marked in
   green.

   ![image](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/studio-verbose-view_sui.jpg)
...
![image](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/studio-navigate-branches_sui.jpg)
...
1. Select one or more check ins in the Check In History by using **Ctrl+click**
   or **Shift+click**.
2. Right-click on the selected records and select **Merge changes to branch**. At this time, it
   is recommended to merge branch changes to the trunk.

   ![image](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/studio-merge-to-branch_sui.jpg)
...
![image](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/mb-1.png)

A confirmation dialog popup appears. The Admin must type ‘delete’ and then select OK button.

![image](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/mb-2.png)
...
![image](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/studio_close_branch_sui.jpg)
...
3. Select **Hotfix**.
   ...
   ![image](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/studio-create-hotfix_sui.jpg)
...
6. Select **Promote Now** to promote the hotfix branch to production:
   ...
   ![image](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/studio-promote-now_sui.jpg)

   The system will generate a branch called Hotfix,
...
See also [Troubleshoot a branched project that cannot be closed](https://community.ibm.com/community/user/viewdocument/troubleshoot-a-branched-project-tha "(Opens in a new tab or window)").
...
If you click **Close Branch** on the **Project** tab and a warning message appears stating
that the branched project cannot be closed, see [Troubleshoot a branched project that cannot be closed](https://community.ibm.com/community/user/viewdocument/troubleshoot-a-branched-project-tha "(Opens in a new tab or window)").
