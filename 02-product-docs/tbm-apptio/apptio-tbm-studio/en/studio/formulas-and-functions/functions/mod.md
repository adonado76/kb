...
Divides one number by another and returns the remainder, preserving the sign of the
dividend (first number).
...
*number*: The number to be divided. This is the dividend in the modulo operation. Note: This
...
*divisor*: The number by which the dividend is divided. Note: This parameter accepts an
...
- The sign of the result always matches the sign of the dividend (the first number),
...
Note: Mod is often used to cycle through values, identify even or odd numbers, or segment
data. The result of Mod has the same sign as the first argument (the dividend).
