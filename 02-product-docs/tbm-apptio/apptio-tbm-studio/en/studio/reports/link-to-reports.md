...
![Link to reports](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/studioimages/studio/stu632.png)
...
|  |  |  |
| --- | --- | --- |
| Report A | Report B  Business Unit FTE | Report C |
...
|  |  |  |
| --- | --- | --- |
| Report A  Business Unit Costs | ---> | Report B Business Unit FTE Report B |
...
![Navigate to Reports](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/studioimages/reports/rep257.png)
...
|  |  |  |
| --- | --- | --- |
| Report A  Business Unit Cost Example | ---> | Report B  Business Unit FTE Example |

To get this result, select the **Business Unit** column in the **Business Unit Costs**
table in Report A and set the navigation options as shown below:

![Navigation Example](../../resources/images/studio_images/studioimages/studio_link%20to%20reports_example%201.png)
...
| Cost column of the Business Unit Costs | Cost column added to Business Unit FTEs |  |
| --- | --- | --- |
| Report A  Business Unit Cost Values | ---> | Report B  Business Unit FTE values |
...
![Navigation example](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/studioimages/reports/rep262.png)
...
| --- | --- | --- | --- | --- |
| Report A  BUC Example | ---> | Report B  FTE example | ---> | Report C |
...
1. Select the **Cost** column in the **Business Unit** Costs table in Report A and set the
   ...
   ![Navigation example](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/studioimages/studio_reports_options.png)
2. Select the **Business Unit** column in the **Business Unit FTEs** table in Report B and
   ...
   ![Navigation example 1](../../resources/images/studio_images/studioimages/studio_business%20unit%20costs%20table_result.png)
