...
![Server Costs](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/studioimages/reports/rep250.png)
...
2. On the **Report** tab, in the **Query** group, click **KPI**. The KPI component is
   added to the report, and the KPI Configuration dialog appears:![Add a KPI component](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/studioimages/studio/stu519.png)
...
![Rename KPI Label](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/rename-kpi_267x531.png)
...
2. Drag metrics into the KPI configuration panel
   ...
   **Rename**.
   ...
   ![Rename KPI Configuration](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/kpi-1_706x440.png)
3. The Rename KPI popup appears.

   ![Rename KPI Popup](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/kpi-popup.png)
4. Enter the appropriate name for the KPI and select **OK**. The KPI is renamed
   successfully.

   ![KPI Rename Successful](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/kpi-rename_693x449.png)
...
![Add variance](../../resources/images/studio_images/studioimages/studio_kpi_add%20variance%20indicators.png)
...
![Add secondary](../../resources/images/studio_images/studioimages/studio_kpi_secondary%20values.png)
...
![Add tertiary values](../../resources/images/studio_images/studioimages/studio_kpi_business_unit_costs.jpg)
