...
breadcrumb: []
source_path: "studio/reports/component end user devices.html"
images:
...
5. Map these tables to the following master tables. For more information, see [Upload data](../data%20studio/upload-data.htm "(Opens in a new tab or window)") and [Map Columns](../data%20studio/mapcolumns.htm "(Opens in a new tab or window)").
...
You must upload data to these tables. For more information, see [Upload data](../data%20studio/upload-data.htm "(Opens in a new tab or window)").
...
3. Configure your input tables to master tables using the formulas listed below. If the Formulas
   ...
   :   - Update the following column for **Active Directory**:
       ...
       - Create and update the following columns for **End User Devices**:
         ...
         ![](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/eud-1.png)

         ![](../../resources/images/studio_images/eud-2_913x453.png)
       - Update the following columns for **Labor Data**:
         ...
         ![](../../resources/images/studio_images/eud-3_913x458.png)
   ...
   :   - Update the following column for **Active Directory**:
       ...
       - Create and update the following columns for **End User Devices**:
         ...
         ![](../../resources/images/end%20user%20devices%20-%20configuration%20guide/component%20end%20user%20devices_1.png)
       - Update the following columns for **Labor Data**:
         ...
         ![](../../resources/images/end%20user%20devices%20-%20configuration%20guide/component%20end%20user%20devices_2_762x592.png)
4. Map End User Devices data to End User Device Input
   by appending it. For more information, see [Append data](../data%20studio/append-data.htm "(Opens in a new tab or window)").

   ![](../../resources/images/end%20user%20devices%20-%20configuration%20guide/component%20end%20user%20devices_3_821x505.png)
...
9. Check End User Insights Master Data to confirm the data flow from **End
   User Insights Pre Master Staging**.

   ![](../../resources/images/end%20user%20devices%20-%20configuration%20guide/component%20end%20user%20devices_4.png)
10. Check End User Insights model to see if most of the costs are getting
    allocated correctly.

    ![](../../resources/images/end%20user%20devices%20-%20configuration%20guide/component%20end%20user%20devices_5.png)

    Note: The cost in the screenshot is for reference purpose only.

    ![](../../resources/images/end%20user%20devices%20-%20configuration%20guide/component%20end%20user%20devices_6.png)
...
![](../../resources/images/end%20user%20devices%20-%20configuration%20guide/component%20end%20user%20devices_7.png)
...
![](../../resources/images/end%20user%20devices%20-%20configuration%20guide/component%20end%20user%20devices_9.png)

[Learn more about End User
Devices reports](end_user_dev_dashboard.htm "(Opens in a new tab or window)")
