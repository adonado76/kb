...
2. Click the **Home** tab, click **New**, and then click **Report**. Note that the items
   displayed in the dialog will depend on your role permissions.![Create a report](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/studioimages/reports/rep339.png)
...
To save a report, click the **Save** icon ![](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/studioimages/icons/save.png) on the
**Home** tab.
...
1. Open the menu under the **Save** icon and click **Save As**.The **Save As** dialog is
   displayed as shown in the following image:![Save a report](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/studioimages/studio/stu514.png)
...
3. On the **Report** tab, click the **Start Date** icon. The **Configure Earliest Applicable
   Date** dialog is displayed as shown in the following image:![Restrict dates for a report](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/studioimages/reports/rep126.png)
