...
- Roles, see [Frontdoor permissions and roles](https://community.ibm.com/community/user/viewdocument/manage-user-permissions-and-roles?CommunityKey=44bcb0d2-5ce6-4504-89eb-019253d3b5d8&tab=librarydocuments "(Opens in a new tab or window)").
- Report permissions, see [Work with report permissions](control-access-reports-11755.html "Applies to: Apptio TBM Studio 12.7 and later.").
...
2. In the **Manage Report Collections** dialog box, click **Add Collection**.![image](../../resources/images/studio_images/studioimages/studio_manage%20report%20collections_add%20collection.png)A new entry is added to the list of collections. The entry
   is named **New report collection**. The new collection is displayed in the
   **Selected Collection** field.

   ![image](../../resources/images/studio_images/studioimages/studio_manage%20report%20coll_new.png)
3. To change the name of the collection, click the **New report collection** entry in the list
   of collections, and then click the collection name in the **Selected Collection**
   field.

   ![image](../../resources/images/studio_images/studioimages/studio_manage%20report%20collections_selected%20collection.png)
...
- Alternatively, in TBM Studio 12.7 and later, you can explore other options described in [Disable reports](disablereports.html "◆ Applies to: TBM Studio 12.7 and later") and [Work with report
  permissions](control-access-reports-11755.html "Applies to: Apptio TBM Studio 12.7 and later.").
...
2. On the **Report** tab, in the **Grouping** group, click **Assign to
   ...
   ![image](../../resources/images/studio_images/studioimages/studio_report_assign%20to%20collection.png)
...
![image](../../resources/images/studio_images/studioimages/studio_report%20collection_custom.png)
...
![image](../../resources/images/studio_images/studioimages/studio_manage%20report%20collections_custom%20finance%20report.png)
...
3. For the report(s) you want to hide, clear the **Show in navigator** checkbox next to the
   report name:![image](../../resources/images/studio_images/studioimages/studio_manage%20report%20collections_cost%20center%20trend.png)
...
![image](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/rc-1_697x318.png)

![image](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/rc-2_732x350.png)
...
To know more about color palette application, refer [Custom Color Palettes](../admin/color-enhancement.html).

![image](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/ccp-rcpopup.png)
