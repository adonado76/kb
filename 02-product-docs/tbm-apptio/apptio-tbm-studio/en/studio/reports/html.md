...
1. From the **Report** tab, click the **HTML** icon. The text box is added to the report and
   the **Edit Content** dialog is opened as shown in the following image:![](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/studioimages/reports/rep146.png)
...
- In the top-left corner of the component, click the small triangle ![](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/studioimages/icons/arrow-down-greyicon.png) next to the
