...
All charts share a common set of configurable properties accessed through the Properties
dialog. Select a chart and access properties via the Properties icon on the Author tab, the Actions
menu (small triangle in the chart header), or by right-clicking the chart.
