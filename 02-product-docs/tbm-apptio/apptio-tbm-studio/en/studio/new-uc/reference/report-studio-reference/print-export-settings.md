...
Print layout settings control how reports appear when exported to PDF format or printed. These
settings can be customized per report to optimize the printed output.

**Accessing Print Layout Mode**

1. Check out the report
2. On the Home tab, click View > Print Layout
3. The Print Layout tab becomes available for configuration
...
Note: *When sharing reports via email link, recipients see the report with the same filters,
slicers, pickers, and date range that were applied when shared.*
