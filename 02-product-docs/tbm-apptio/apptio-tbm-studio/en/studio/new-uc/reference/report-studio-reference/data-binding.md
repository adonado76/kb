...
Input components bind to editable table columns, which store user-entered data in the project
database.
...
Important: The binding is not real-time. Users must explicitly save and publish changes
for them to affect the cost model.
