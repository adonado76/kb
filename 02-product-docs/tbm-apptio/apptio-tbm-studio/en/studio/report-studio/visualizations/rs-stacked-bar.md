...
title: "Stacked Bar"
breadcrumb: []
source_path: "studio/report-studio/visualizations/rs-stacked-bar.html"
images:
  - "resources/images/studio_images/rs-sample-stkbar.png"
  - "resources/images/studio_images/rs-stkdbar.png"
capability_ids: []
...
2. Go to **Visualizations** and then select the **Stacked Bar** tile.

   ![stacked bar tile](../../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/rs-stkdbar.png)
3. Click the Stacked bar visualization to enable the **Data** and **Format**
   panels.
4. Expand the panels to configure the data and format options:
   ...
   | Legend | Drag or add the data for legend. |
   | Y-axis | Drag or add the data for Y-axis |
   | X-axis | Drag or add the data for X-axis |
   | Filters | Drag or add the filter criteria |
   | **Format - Properties** | |
   | X-axis | Edit the following properties, as required - Toggle to show X-axis title. Add a title to the Bar chart. - Toggle to show X-axis values - Font size and style (bold, italics, underline) - Color of the X-axis title text and values (with option to reset the color) - Toggle to switch axis position - Toggle to show X-axis grid lines |
...
A sample stacked bar chart is shown below:

![stacked bar chart sample](../../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/rs-sample-stkbar.png)
