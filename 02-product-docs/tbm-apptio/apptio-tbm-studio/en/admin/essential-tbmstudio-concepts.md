...
breadcrumb: []
source_path: "admin/essential-tbmstudio-concepts.html"
images: []
capability_ids: []
...
- Reports — A properly structured data model will enable you to create a
  ...
  information, see [About Report Studio](../reports/report-studio-title-topic.html "Applies to: TBM Studio 12.0 and later").
