...
breadcrumb: []
source_path: "admin/use_the_performance_review.html"
images: []
capability_ids: []
...
- For installation instructions, see [Install the Performance Review component](install-performance-review.html "(Opens in a new tab or window)")
...
component](Install the Performance Review%0Acomponentinstall-performance-review.dita "(Opens in a new tab or window)").
...
7. At this point, you may choose to revert the change to the Components Version, so that all the
   ...
   2. In the revert dialog, select only Project Settings and select **Revert
      Check Out**.
...
Installing the Performance Review component creates a report that is accessible throughApptio TBM
Studio. This report is available to users with the ADMIN role. For more information, see Manage user
...
Click the ToolTip icon ![](../../resources/images/use%20the%20performance%20review%20component/use%20the%20performance%20review_3.png)for any given table for information on the table contents. In some cases, the content of the tabs
may not initially render. If a table doesn’t load, righ- click and select update data.
...
![](../../resources/images/use%20the%20performance%20review%20component/use_the_performance_review_5_sui.png)
...
object, select AR rows > Sort Descending. Select the ToolTip icon ![](../../resources/images/use%20the%20performance%20review%20component/use%20the%20performance%20review_3.png)in the report for more information.
...
![](../../resources/images/use%20the%20performance%20review%20component/use_the_performance_review_10_sui.png)
...
![](../../resources/images/use%20the%20performance%20review%20component/use_the_performance_review_19_sui.png)
