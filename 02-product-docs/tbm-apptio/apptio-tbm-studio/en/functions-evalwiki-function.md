...
breadcrumb:
  ...
  - "EvalWiki function"
source_path: "SSWRJM/studio/formulas-and-functions/functions/evalwiki.html"
images: []
capability_ids: []
...
Assume you have a large block of text that you want to maintain in one place in the system and place on multiple report pages. This can be done using EvalWiki. Make a one-row data set (e.g.: TextBlocks) with a column named Text. Enter the block of text in the table cell.
...
1. In the Edit Column dialog, check the Force Label option.
1. Enter a formula such as the following: =EvalWiki("[[/myObject/!FILTER[myColumn="""&myColumn&"""]/ myReport|click here to see my report]]")
