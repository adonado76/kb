...
breadcrumb:
  ...
  - "Edit Permissions"
source_path: "SSWRJM/studio/new-uc/reference/report-studio-reference/edit-permissions.html"
images: []
capability_ids: []
...
This expression disables editing for the specified user. You can use any dynamic text expression that evaluates toevaluates true or false.
