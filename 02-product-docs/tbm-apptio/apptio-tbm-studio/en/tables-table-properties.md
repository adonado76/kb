...
breadcrumb:
  ...
  - "Table Properties"
source_path: "SSWRJM/studio/new-uc/reference/report-studio-reference/table-properties.html"
images: []
capability_ids: []
...
Access the Properties dialog by right-clicking the table's Total bar and selecting Properties. Properties are organized into Data, General, and Advanced tabs.
