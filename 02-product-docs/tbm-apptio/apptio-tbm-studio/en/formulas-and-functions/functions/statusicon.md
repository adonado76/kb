...
breadcrumb: []
source_path: "formulas-and-functions/functions/statusicon.html"
images: []
capability_ids: []
...
>
> green icon ![](../../../resources/images/studio_images/studioimages/icons/small_greenicon.png).

*red\_expression*

> An expression that evaluates to true or false. If true, the function returns a
>
> red icon ![](../../../resources/images/studio_images/studioimages/icons/small_redicon.png).

If both expressions evaluate to true, the function returns a blue icon ![](../../../resources/images/studio_images/studioimages/icons/small_blueicon.png).

If neither expression evaluates to true, the function returns a yellow icon ![](../../../resources/images/studio_images/studioimages/icons/small_yellowicon.png).

If there is an error in the rules (for example, if a variable is specified that doesn't exist),
the function returns a gray icon ![](../../../resources/images/studio_images/studioimages/icons/small_grayicon.png).
