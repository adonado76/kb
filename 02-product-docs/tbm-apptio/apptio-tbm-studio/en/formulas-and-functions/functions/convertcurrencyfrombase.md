...
breadcrumb: []
source_path: "formulas-and-functions/functions/convertcurrencyfrombase.html"
images: []
capability_ids: []
...
The ConvertCurrencyFromBase function multiplies the value by the rate in the Currency Exchange
table.
...
> ```
> ConvertCurrencyFromBase(source column,"currency
>           code","rate type")
> ```
