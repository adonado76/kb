...
breadcrumb:
  ...
  - "Report Permissions"
  - "Permission Types"
source_path: "SSWRJM/studio/new-uc/reference/report-studio-reference/permission-typs.html"
images: []
capability_ids: []
...
View permissions determine which roles can see a report when navigating through the Project Explorer or Report Collections.

Configuring View Permissions:

1. Check out the report
1. On the Report tab, in the Advanced group, click Permissions
1. Select the roles that should have access to view the report
...
Edit permissions are typically controlled through project-level roles rather than individual report settings. Users who can edit reports must have:
...
1. Add, remove, or configure report components
1. Modify table and chart configurations
1. Change report properties and settings
1. Save and check in changes

The Edit Personal Reports Permission

A specific permission called Edit Personal Reports allows users to create reports visible only to themselves. This permission:
...
Report administration capabilities are tied to the Admin role (or custom roles with equivalent permissions). Administrators can:
