...
breadcrumb:
  ...
  - "Find function"
source_path: "SSWRJM/studio/formulas-and-functions/functions/find.html"
images: []
capability_ids: []
...
*Returns the position of the first occurrence of a search string within another string, starting at an optional position. This function is case-sensitive.*
...
- If starting_position is not provided, the search begins from the start of the string.
- The function behaves like Search, but it is case-sensitive.

## Examples

- Find("Functional", "58762 Functional Actuals"): Returns 7, the position of the substring 'Functional'.
- Find("c", "58762 Functional Actuals", 12): Returns 19, starting the search after the 12th character.
- Find("99", "58762 Functional Actuals"): Returns 0, since '99' is not found.
- LEFT(IP, Find(".", IP, Find(".", IP) + 1)): Returns the first two octets of an IP address. For example, for '10.10.1.113' the result is '10.10'.
