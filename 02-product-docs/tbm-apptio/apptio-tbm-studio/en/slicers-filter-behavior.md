...
breadcrumb:
  ...
  - "Filter Behavior"
source_path: "SSWRJM/studio/new-uc/reference/report-studio-reference/filter-behavior.html"
images: []
capability_ids: []
...
When users open the report, the slicers display the default values selected. Users can modify selections during their session.
