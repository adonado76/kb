...
breadcrumb:
  ...
  - "Row function"
source_path: "SSWRJM/studio/formulas-and-functions/functions/row.html"
images: []
capability_ids: []
...
*Returns the index of the current row in the table, starting with zero for the first row.*
...
Evaluates to the zero-based index of the current row within the table. The first row is numbered 0, the second is 1, and so on.
