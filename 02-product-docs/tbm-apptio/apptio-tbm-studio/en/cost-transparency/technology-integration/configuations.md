...
![Configuration](../../../../../03-media/apptio-tbm-studio/resources/images/ct_images/trb-cnfg-1.jpg)
...
![Datadrop Viewer](../../../../../03-media/apptio-tbm-studio/resources/images/ct_images/trb-cnfg-2.jpg)

Next, create a new Datalink Connector using the Datadrop Connector type.

![Datadrop Connector](../../../../../03-media/apptio-tbm-studio/resources/images/ct_images/trb-cnfg-3.jpg)

![Connections](../../../../../03-media/apptio-tbm-studio/resources/images/ct_images/trb-cnfg-4.jpg)
...
![Pending Actions](../../../../../03-media/apptio-tbm-studio/resources/images/ct_images/trb-cnfg-5.jpg)
...
![On Prem Pending Actions](../../../../../03-media/apptio-tbm-studio/resources/images/ct_images/trb-cnfg-6.jpg)
...
3. As data enters the Turbo Actions Feed table, it will link to existing Apptio data models,
   ...
   1. Appending Infrastructure Master Datasets (e.g., Servers Master Data) into the Infrastructure
      ...
      ![Infrastructure Master Datasets](../../../../../03-media/apptio-tbm-studio/resources/images/ct_images/trb-stp3a.jpg)
   2. Creating new drivers for Hybrid Cost and Hybrid Charge models, linking cost and charge from the
      ...
      ![Hybrid Cost and Hybrid Charge models](../../../../../03-media/apptio-tbm-studio/resources/images/ct_images/trb-stp-3b.jpg)
...
6. The  *Hybrid IT Optimization*  component creates a set of editable Workbench tables, which
   ...
   - **Target & Settings**  : Ensure COIN Targets are set according to internal agreements.
     ...
     ![Target & Settings](../../../../../03-media/apptio-tbm-studio/resources/images/ct_images/trb-stp6.jpg)
   - **Filters**  : Exclude any Actions or Entity Types that do not impact potential or realized
     savings.

     ![Filters](../../../../../03-media/apptio-tbm-studio/resources/images/ct_images/trb-stp6filt.jpg)
...
7. As part of the  *Hybrid IT Optimization*  component, several additional tables are
   ...
   - **Optimization Impact**  : The extent to which infrastructure is optimized or impacted.
     ...
     ![Optimization Impact](../../../../../03-media/apptio-tbm-studio/resources/images/ct_images/trb-stp7-oi.jpg)
   - **Infra without any Actions**  : Infrastructure without pending or executed actions.
     ...
     ![ Infra without any Actions ](../../../../../03-media/apptio-tbm-studio/resources/images/ct_images/trb-stp7b.jpg)
...
10. Append the existing Apptio infrastructure  *Relationship*  data into the new Infrastructure
    Relationships object. This is done for efficiency rather than expanding the previous dataset. ![Relationship](../../../../../03-media/apptio-tbm-studio/resources/images/ct_images/trb-stp-10.jpg)
