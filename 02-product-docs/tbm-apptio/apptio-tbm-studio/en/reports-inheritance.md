...
breadcrumb:
  ...
  - "Master Reports"
  - "Inheritance"
source_path: "SSWRJM/studio/new-uc/reference/report-studio-reference/inheritance.html"
images: []
capability_ids: []
...
When you apply a master report to a custom (child) report, the master's content appears as a background layer. The child report inherits the visual appearance and any interactive elements defined in the master, but the inheritance model follows the "wallpaper" concept:
...
- Tab component content areas : You cannot add components to individual tabs within the child report
