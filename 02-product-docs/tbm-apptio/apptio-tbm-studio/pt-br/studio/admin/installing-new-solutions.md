...
1. **Verifique a versão do servidor:** verifique se a versão do servidor da sua instância é igual ou mais recente que a versão de lançamento da solução.
...
| TCO do mainframe | - | Sim | v120 | A ser lançado |
| Informações sobre os custos de manutenção do Maximo | N.A. | N.A. | v200 | 12.11.15 |
