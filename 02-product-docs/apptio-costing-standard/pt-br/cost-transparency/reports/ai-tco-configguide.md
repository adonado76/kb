...
title: "Guia de configuração do TCO da IA"
breadcrumb:
  - "Costing Standard"
  - "Outras soluções"
...
summary: ""
---
# Guia de configuração do TCO da IA
...
![Imagem 1](../../../../../03-media/apptio-costing-standard/resources/images/ct_images/aicomcon.png)
...
![Um quadrado verde com uma cabeça com um fone de ouvido](../../../../../03-media/apptio-costing-standard/resources/images/ct_images/aitco.png)
...
1. Componente **TCO e uso de IA** : Esse componente oferece uma visão clara dos gastos e da utilização de IA em modelos de IA, soluções de IA e unidades de negócios. Esse componente estabelece a estrutura subjacente por meio de um conjunto de novos conjuntos de dados mestre específicos de IA, bancos de trabalho, modelos e métricas, facilitando a modelagem e o cálculo do TCO da IA e dos resultados de uso.
   ...
   ![Figura](../../../../../03-media/apptio-costing-standard/resources/images/ct_images/aictf.png)
2. Componente **CTF – Fonte de Custo** : Uma nova versão do componente CTF – Fonte de Custo está disponível, adicionando os seguintes **novos campos** aos Dados Mestres de Fonte de Custo para dar suporte à solution.:
   ...
   ![Um quadrado verde com um logotipo branco e azul](../../../../../03-media/apptio-costing-standard/resources/images/ct_images/aictapp.png)
3. Componente **CT Apps - Serviços** : Está disponível uma nova versão do componente CT Apps - Services, que adiciona novos campos a All Business Services para dar suporte à solução AI TCO & Usage.
   ...
   ![Um logotipo verde e branco](../../../../../03-media/apptio-costing-standard/resources/images/ct_images/aitcoreport.png)
...
![Um diagrama de uma empresa](../../../../../03-media/apptio-costing-standard/resources/images/ct_images/aiarch.png)
...
![Um diagrama de uma empresa](../../../../../03-media/apptio-costing-standard/resources/images/ct_images/optb.png)
...
![Figura](../../../../../03-media/apptio-costing-standard/resources/images/ct_images/arch1.png)
...
[![](../../../../../03-media/apptio-costing-standard/resources/images/icons/aitco.png)](../../resources/AITCO-usage.xlsx "(Abre em uma nova guia ou janela)")
...
Para ver as visualizações e os principais benefícios fornecidos com os relatórios acima, clique [aqui](ai-tco-report-collection.html).
