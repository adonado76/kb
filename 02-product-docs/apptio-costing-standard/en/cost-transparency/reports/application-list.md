...
![image](../../resources/images/ct_images/ct%20report%20collections/application%20list.jpg)

| Key element | Description |
| --- | --- |
| (1) Report Collection | This report collection provides the details you need to review your application spend, trends, and usage:  - [Application Review report](application_review.html)   (open by default) - [Application Portfolio   report](application_portfolio.html) - Application List (described in this page - [Infrastructure   Analysis by Application report](infrastructure_analysis_by.html) - [New & Retired Apps   report](new_retired_apps.html) |
