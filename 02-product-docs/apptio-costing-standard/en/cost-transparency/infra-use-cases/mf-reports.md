...
title: "Mainframe Reports"
breadcrumb:
  - "Costing Standard"
  - "Infrastructure Use Cases"
  - "Mainframe"
source_path: "cost-transparency/infra-use-cases/mf-reports.html"
images:
  - "resources/images/ct_images/costpool-composition.png"
  - "resources/images/ct_images/mf-anlys.png"
  - "resources/images/ct_images/mf-model.png"
  - "resources/images/ct_images/mf-projected-annual-cost.png"
  - "resources/images/ct_images/mf-utilization.png"
  - "resources/images/ct_images/mfshwbk.png"
  - "resources/images/ct_images/mfutil.png"
  - "resources/images/studio_images/mainframe-app.png"
capability_ids: []
...
- Mainframe TCO – Model View

**Mainframe TCO - Cost Transparency & Allocation**

This report provides a comprehensive view of total mainframe cost and consumption by combining
costs, GCP/zIIP MSUs, and calculated unit costs in one integrated view.

Use this report to understand the complete mainframe cost picture, identify major cost drivers,
and communicate TCO to stakeholders. The report breaks down spending across labor, vendors to
...
![Mainframe TCO Solution](../../../../../03-media/apptio-costing-standard/resources/images/ct_images/mf-projected-annual-cost.png)
...
![Benchmark percentage](../../../../../03-media/apptio-costing-standard/resources/images/ct_images/costpool-composition.png)
...
![Mainframe Cost Transparency & Allocation Unit Cost](../../../../../03-media/apptio-costing-standard/resources/images/ct_images/mf-anlys.png)

**Mainframe Application**

This report provides a comprehensive view of mainframe-backed applications, combining
application-level costs, business volumes, unit costs, and mainframe consumption metrics (GCP and
zIIP MSUs) into a single integrated view. It enables organizations to understand how mainframe
resources are consumed by individual applications and how those costs translate into business value.
...
- View application-level total cost, cost YTD, GCP MSU, and zIIP MSU consumption in a single
  integrated view.
- Understand unit cost by business volume (e.g., cost per order, cost per account, cost per
  transaction).
- Analyze spend by application family, investment objective, and lifecycle stage (Invest, Migrate,
  Tolerate, Eliminate).
- Identify high-cost or high-consumption applications to prioritize optimization, modernization,
  or retirement decisions.

![Mainframe Application](../../../../../03-media/apptio-costing-standard/resources/images/studio_images/mainframe-app.png)
...
![](../../../../../03-media/apptio-costing-standard/resources/images/ct_images/mfutil.png)
...
![](../../../../../03-media/apptio-costing-standard/resources/images/ct_images/mfshwbk.png)
...
![](../../../../../03-media/apptio-costing-standard/resources/images/ct_images/mf-utilization.png)

**Mainframe TCO - Model View**

This report visualizes the complete cost flow from beginning to end in the mainframe cost
model. The report traces underlying cost drivers feeding into the mainframe processor
including direct costs from the General Ledger such as depreciation, as well as labor and
vendor costs.

Use this report to understand how costs flow through the model and how usage data drives the
allocation of mainframe TCO to business applications. The visualization supports validation of
allocation methodologies and cost model accuracy.
...
- Visualization of cost flow from beginning to end in the mainframe cost model.
- Tracing of underlying cost drivers feeding into the mainframe processor including direct
  costs from General Ledger.
- Understanding of how labor and vendor costs contribute to total mainframe TCO.
- Visualization of how usage data drives the allocation of mainframe TCO to business
  applications.

![Mainframe Model](../../../../../03-media/apptio-costing-standard/resources/images/ct_images/mf-model.png)
