...
Mainframe TCO solution is designed to solve

- Limited visibility of total cost of ownership.
- Understanding true unit cost metrics of workloads.
- Inability to accurately allocate mainframe costs.

![Mainframe TCO Painpoints](../../../../../03-media/apptio-costing-standard/resources/images/ct_images/mainframe-tco-painpoints.png)

  

It supports the following use cases

![Use Case](../../../../../03-media/apptio-costing-standard/resources/images/ct_images/use-case.png)
...
- IBM Apptio Server Version: R12.11.17 (or higher), Beta Version – R12.11.16 (or higher)
...
architecture. Existing customers can re-use the previously installed components without any
changes.Before installing the components, refer to the next section on architecture to ensure proper
consideration, whether to install them in an existing project or create a new project for the
Mainframe TCO & Usage solution. What follows is an overview of the 4 components, in the
prioritized order to consider and install them.

**Configure Mainframe Object in the existing Cost Transparency project**. These changes need
to be done in TBM Studio
...
2. Install the component CT Apps- Applications.
   ...
   Note: For the component BI-Mainframe Insights, two components must be pre-installed and configured.
   - CTF-Cost Source
   - CTF- IT Tower
