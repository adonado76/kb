...
title: "Guía de configuración del coste total de propiedad (TCO) de mainframe"
breadcrumb:
  - "Costing Standard"
...
summary: ""
---
# Guía de configuración del coste total de propiedad (TCO) de mainframe
...
8. GCP Asignación de MSU al mainframe.
   - En «Modelo», selecciona la métrica « GCP » (MSU) y, a continuación, haz clic en **«Añadir controlador de unidad».**

     ![Añadir controlador de unidad](../../../../../03-media/apptio-costing-standard/resources/images/ct_images/add-unit-driver.png)
   - Utiliza la columna **«CPU de GCP » (Consumo de MSU)** para rellenar el controlador y asígnale el nombre «**Controlador de unidades MSU** de GCP ».

     ![GCP MSU](../../../../../03-media/apptio-costing-standard/resources/images/ct_images/gcp-msu.png)
   - Selecciona «**Guardar** y aplicar» para incorporar los datos de la unidad de software (MSU) de « GCP » al objeto «Mainframes».

     ![Guardar cambios](../../../../../03-media/apptio-costing-standard/resources/images/ct_images/save-gcp-msu.png)

   Nota: Las MSU de « GCP » son controladores de unidad específicos del objeto «Mainframes» y solo deben asignarse desde Mainframe. Esta asignación debe eliminarse manualmente si existe asignación de cualquier otro objeto.
...
10. Imputación de costes de Mainframe a Aplicación.
    - Seleccione «Metric Cost» y, a continuación, seleccione las métricas « GCP » y « zIIP ».
...
- **Análisis de Mainframe**
  ...
  - Consulte el consumo de recursos de « GCP » y « zIIP » en la MSU y compare los diferentes tipos de procesamiento de cargas de trabajo.
