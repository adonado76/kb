...
breadcrumb: []
source_path: "admin/default-calc-prioritization.html"
images: []
capability_ids: []
...
urgency. It is applicable across all projects, domains, and branches in their instance within TBM
Studio. Projects will now be calculated according to the numbers assigned to them. Administrators
...
Navigate to Build tab on the TBM Studio Ribbon and select Calc Prioritization![](../../resources/images/studio_images/calc-prioritization.png)
