...
breadcrumb: []
source_path: "model_studio/create-custom-table-identifier.html"
images: []
capability_ids: []
...
3. In the Rows panel shown in the following image, check the columns you
   ...
   shows the cost for each row and the amount allocated:![](../../resources/images/studio_images/studioimages/studio/stu607.png)
