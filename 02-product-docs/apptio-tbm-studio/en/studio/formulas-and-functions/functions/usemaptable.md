...
The end result of this method is the same as the original use\_map\_table function, follows TBM Studio version 12 best practices, and allows the Apptio modeling engine optimizations to have their
full effect.
