...
*string\_expression*: The value to evaluate. Can be a literal string, a column reference, or
a concatenated expression. Note: This parameter accepts an expression, meaning you can
