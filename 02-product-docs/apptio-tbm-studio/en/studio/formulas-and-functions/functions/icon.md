...
| --- | --- |
| "redcircles" | Expression 1: red circle red circleExpression 2: pink circle pink circle |
| "3colorcircles" | Expression 1: green circle green circleExpression 2: yellow circle yellow circleExpression 3: red circle red circle |
| "3arrows" | Expression 1: up arrow green upward arrowExpression 2: right arrow yellow rightward arrowExpression 3: down arrow red downward arrow |
| "3arrowsinv" | Expression 1: up arrow Expression 2: right arrow yellow rightward arrowExpression 3: down arrow green downward arrow |
| "4arrows" | Expression 1: up arrow green upward arrowExpression 2: up right arrow yellow up rightward arrowExpression 3: down right arrow Expression 4: down arrow red downward arrow |
| "4arrowsinv" | Expression 1: up arrow Expression 2: up right arrow yellow up rightward arrowExpression 3: down right arrow yellow down rightward arrowExpression 4: down arrow green downward arrow |
| "5arrows" | Expression 1: up arrow green upward arrowExpression 2: up right arrow yellow up rightward arrowExpression 3: right arrow yellow rightward arrowExpression 4: down right arrow yellow down rightward arrowExpression 5: down arrow red downward arrow |
| "5arrowsinv" | Expression 1: up arrow Expression 2: up right arrow yellow up rightward arrowExpression 3: right arrow yellow rightward arrowExpression 4: down right arrow yellow down rightward arrowExpression 5: down arrow green downward arrow |
| "redcircles" | Expression 1: red circle red circleExpression 2: pink circle |
| "3colorcircles" | Expression 1: green circle green circleExpression 2: yellow circle yellow circleExpression 3: red circle red circle |
| "3arrows" | Expression 1: up arrow green upward arrowExpression 2: right arrow yellow rightward arrowExpression 3: down arrow red downward arrow |
| "3arrowsinv" | Expression 1: up arrow Expression 2: right arrow yellow rightward arrowExpression 3: down arrow |
| "4arrows" | Expression 1: up arrow green upward arrowExpression 2: up right arrow yellow up rightward arrowExpression 3: down right arrow yellow down rightward arrowExpression 4: down arrow red downward arrow |
| "4arrowsinv" | Expression 1: up arrow Expression 2: up right arrow yellow up rightward arrowExpression 3: down right arrow yellow down rightward arrowExpression 4: down arrow |
| "5arrows" | Expression 1: up arrow green upward arrowExpression 2: up right arrow yellow up rightward arrowExpression 3: right arrow yellow rightward arrowExpression 4: down right arrow yellow down rightward arrowExpression 5: down arrow red downward arrow |
| "5arrowsinv" | Expression 1: up arrow  Expression 2: up right arrow yellow up rightward arrow  Expression 3: right arrow yellow rightward arrow  Expression 4: down right arrow yellow down rightward arrow  Expression 5: down arrow green downward arrow |
