...
Rounds a real number to a specified number of decimal places using the 'round-half-up'
algorithm. This means that values ending in .5 are rounded away from zero.
...
*numeric\_expression*: An expression that evaluates to the number to be rounded. Note: This
...
*digits*: An integer expression that specifies the number of decimal places to round to.
