...
![date partition](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/studioimages/studio/stu305.png)
...
![data formats](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/studioimages/studio/aug103.png)
...
![data formats](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/studioimages/studio/aug104.png)
...
![row based data](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/studioimages/studio/stu507.png)

![row based data](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/studioimages/studio/stu508.png)
...
in a fiscal or calendar year. The column headings can be any valid date format such as Jan,
Jan 2016, or P1 2016. When the column headings specify a year only, the year must be on its
own or last in the heading, e.g. 2016 or Rate 2016 but not 2016 Rate. A table like the one
shown in the following image, when date partitioned, would look like the table in the
subsequent image:

![column based data](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/studioimages/studio/stu509.png)

![column based data](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/studioimages/studio/stu510.png)
...
4. Select the column sets that should be used to partition the data. If the data set includes two
   or more sets of columns, you can partition the data by each set. For example, assume you
   have a data set that includes monthly columns for both cost and budget as shown in the
   following image:

   ![column based data](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/studioimages/studio/stu306.png)
5. You can choose to partition the data by Cost, Budget, or both. If you choose **Cost**, the
   result would look like the following image:

   ![column based data](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/studioimages/studio/stu307.png)

   If you choose **Budget**, the result
   would look like the following image:

   ![column based data](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/studioimages/studio/stu308.png)

   And, if you choose both **Cost** and
   **Budget**, the result will look like the following image:

   ![column based data](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/studioimages/studio/stu309.png)
