...
5. Do one of the following:
   ...
   - Drag a file into the **Details** pane.
     ...
     An **Import** step is added to the
     pipeline.

     ![Upload data](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/studioimages/studio/stu599.png)
6. Click the **Import** step in the pipeline and review the settings:
   - **Start import at row**: Indicate the first row in the table to be included in the import.
     The import always includes the header row in the file. The number you enter designates the data row
     where the import will start. For example, in the spreadsheet below, entering a 2 in the field will
     start with the New York row because it is the second row of data.![Start import at row](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/studioimages/studio/stu657.png)
...
![Data and cardinality validation](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/studioimages/studio/stu680.png)
...
2. Change the date picker to the period where the data will be added. A place holder is added to
   ...
   added:![Upload additional data into a table](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/studioimages/studio/stu571.png)
...
:   A sample criteria for the following conditions
    ...
    ![Uploading data during invalid time period](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/closed_period.png)

    ![Uploading data during invalid time period 2](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/closed_period_1.png)

    ![Uploading data during invalid time period 3](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/closed_period_2.png)

    ![Uploading data during invalid time period](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/closed_period_3.png)
...
![Data Refresh Cycles](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/image-upload-data-file-2021_700x328.png)
...
Note: This link appears for all data refresh options, except **Ad-Hoc update**s
and **1 version; No scheduled updates**.

![Data Expiration Check](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/config-notification_601x120.png)

Click the link to provide the details and select the **Create** button.

![Notification Popup](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/late-noti-popup.png)
...
![configuration details](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/late-file-noti.png)
...
![Date Freshness Check](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/data-freshness.png)
