...
1. Click the **Plus-Parenthesis**![](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/studioimages/icons/paren.png) icon on the right. ![](../../resources/images/studio_images/studioimages/studio_filter_add%20row.png)
...
- To add an expression line with another layer of sub-nesting, click the
  **Plus-Parenthesis** icon ![](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/studioimages/icons/paren.png) at the right. Select a
...
- To delete a line, click the **Delete** icon ![](../../../../../03-media/apptio-tbm-studio/resources/images/studio_images/studioimages/icons/delete_icon.png) at the right of the
  criteria.
