...
- ServiceNow Ingress connector enables to push data from ServiceNow to Apptio.
  ...
  [DataLink ServiceNow Ingress connector](/docs/SSEXLU7/datalink/c-servicenow-about-connector.html)
...
3. In DataLink, configure the DataLink egress
   connector.

   [Learn more about configuring the
   DataLink egress connector](#ConfigureaServiceNowEgressconnection__ToconfigureaServiceNowEgressconnection)
...
:   If you are using OAuth 2.0 authentication for your connector, you need to obtain a token from
    ...
    1. Register DataLink as a client application with your ServiceNow OAuth 2.0
       source.
...
:   1. Select the authentication type to connect to your ServiceNow instance: Basic or OAuth
    ...
    3. Enter your authentication details:
       ...
       - If you are using OAuth 2.0 authentication, do the following:
         ...
         DataLink encrypts the access token and uses it while running the
         connector.

       Note: When the OAuth 2.0 access token expires, DataLink automatically
       tries to refresh it.

Enter report details
:   1. In Fill in the Report details, select the BIIT host where the Costing
       Standard report resides. If you have just one BIIT instance, DataLink
    ...
    3. Enter Costing Standard report URLs for each of the reports, as follows:
       ...
       3. Copy the report URL in JSON format from into the DataLink Report URL
