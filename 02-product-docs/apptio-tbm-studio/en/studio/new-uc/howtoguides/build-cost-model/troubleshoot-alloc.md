...
- **Use data relationships:** Constrains allocation scope and improves
  performance.
- **Reduce identifier granularity:** Fewer unique identifiers mean smaller allocation
  tables.
...
- [Trace Cost Flows Through the Model](trace-cost-flow.html): Learn to track individual costs through multiple
  tiers.
- [Create Model Reports (Sankey Diagrams)](create-model-rep.html): Build Sankey visualizations of your cost model.
- Understand [Model
  Architecture](../../concepts-architecture/model-architecture/model-concepts-overview.html): Deepen your knowledge of how allocations work.
