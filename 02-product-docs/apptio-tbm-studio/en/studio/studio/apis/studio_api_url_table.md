...
the ETL tool, see [https://community.apptio.com/docs/DOC-4223](https://community.apptio.com/docs/DOC-4223 "(Opens in a new tab or window)")[DataLink API sample scripts](../../../datalink-classic/api-dlc-sample-scripts.html).
