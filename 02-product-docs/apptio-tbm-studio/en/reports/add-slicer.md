...
title: "Add a slicer"
breadcrumb: []
source_path: "reports/add-slicer.html"
images: []
capability_ids: []
...
For a more detailed discussion of these options, see [Select a search option](select-search-option.htm "(Opens in a new tab or window)").
