...
breadcrumb: []
source_path: "reports/waterfall-charts.html"
images: []
capability_ids: []
...
6. Click the save icon ![](../../resources/images/studio_images/studioimages/icons/check.png).
7. Click the custom color icon ![](../../resources/images/studio_images/studioimages/icons/custom%20color.png) and select a
   color.
8. Click Save.
...
logs into Apptio and opens the waterfall chart. He selects Chicago from the slicer. He enters his
intermediate steps as shown in the following image. The heads of the other data centers do the
same.
...
the intermediate steps, the VP combines the data and creates a single intermediate step for each
cost center. The final chart is shown in the following image:
