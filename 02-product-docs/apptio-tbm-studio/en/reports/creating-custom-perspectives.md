...
breadcrumb: []
source_path: "reports/creating-custom-perspectives.html"
images: []
capability_ids: []
...
3. Drag a field from an area in the Component Configuration panel to the
   ...
   Explorer.
4. Right-click a field in the Component Configuration panel and select
   Publish.![](../../resources/images/studio_images/studioimages/studio/stu609.png)
