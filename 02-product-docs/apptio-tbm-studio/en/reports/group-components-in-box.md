...
breadcrumb: []
source_path: "reports/group-components-in-box.html"
images: []
capability_ids: []
...
![](../../resources/images/studio_images/studioimages/visio%20diagrams/group-box-borders.png)
...
- In the top-left corner of the icon, click the small triangle ![](../../resources/images/studio_images/studioimages/icons/arrow-down-greyicon.png) next to the
  component name to display the Actions menu. From the
