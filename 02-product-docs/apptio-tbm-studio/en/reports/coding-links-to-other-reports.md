...
breadcrumb: []
source_path: "reports/coding-links-to-other-reports.html"
images: []
capability_ids: []
...
- For information on creating HTML text boxes, see [HTML text box](html.htm "(Opens in a new tab or window)").
- For information on creating buttons, see [Button](button.htm "(Opens in a new tab or window)").
