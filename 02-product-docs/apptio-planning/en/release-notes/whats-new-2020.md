...
breadcrumb: []
source_path: "release-notes/whats-new-2020.html"
images: []
capability_ids: []
...
:   You can now view the list of dimensions grouped by the dimension type when configuring
    ...
    User guide: [Planning data in Apptio BI](../../it-planning/planning/it-planning-data-self-servic-reporting.dita "(Opens in a new tab or window)")
...
:   You can now connect multiple ITP instances to a single shared CT instance - for example, a
    ...
    Cost Transparency](../../it-planning/planning/integrate-ct.dita "(Opens in a new tab or window)") and CT Integration Panel.
...
:   We have enhanced the Costing Standard Integration experience to provide centralized
    ...
    [Integrate
    with Cost Transparency](../../it-planning/planning/integrate-ct.dita "(Opens in a new tab or window)") and CT Integration Panel.
...
◆ Applies to: Planning, Planning Foundation, Project Financial Planning, and/or Service Demand
Planning as noted below.

In this release:

- [Department Level 1 and Level 2 Dimensions in Apptio BI](../../it-planning/release-notes/whats-new-2020.dita?#Departme "(Opens in a new tab or window)")
- [Stay informed about product updates](../../it-planning/release-notes/whats-new-2020.dita?#Stay "(Opens in a new tab or window)")
...
- See also [Planning Weekly Maintenance Schedule](https://community.apptio.com/docs/DOC-6388 "(Opens in a new tab or window)").
- See if Apptio planning applications have any current known issues in [Apptio Known Issues](https://community.apptio.com/community/apptio/product-central/apptio-known-issues "(Opens in a new tab or window)").
