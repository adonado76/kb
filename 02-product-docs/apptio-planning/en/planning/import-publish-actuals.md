...
language: "en"
doc_type: "planning"
title: "Import and publish actuals"
breadcrumb: []
source_path: "planning/import-publish-actuals.html"
images: []
capability_ids: []
...
1. In the navigation menu, select Spend Management > Transactions.
   ...
   The Enforce View Permissions feature can be enabled in the Company Profile. See [Edit the Company Profile](edit-company-profile.htm "(Opens in a new tab or window)"). If
...
3. Open the downloaded .csv file.
   ...
   - Optionally, add custom dimension column headings to the template (see [Add and manage custom attributes of
     dimensions)](manage_schema.htm "(Opens in a new tab or window)").
...
3. Select Actions, then select from the following:
   ...
   - Import from Costing Standard - Import actuals from Costing Standard (see [Integrate with Cost Transparency](integrate-ct.htm "(Opens in a new tab or window)")).
...
Summary or Ledger page. See [Analyze a plan or forecast](analyze-plan-forecast.htm "(Opens in a new tab or window)"). Note that:
...
- Budget owners can edit attributes of forecast line items while still being able to align actuals
  ...
  these settings to a view using the Custom Layouts feature (see [Customize, save, and share table layouts)](customize-save-share.htm "(Opens in a new tab or window)").
- You can add custom attributes to the table which can help capture supplemental information to
  ...
  and manage custom attributes of dimensions)](manage_schema.htm "(Opens in a new tab or window)").
...
- If your organization runs both Planning and Apptio Costing Standard, you can integrate the two
  to share data (see [Integrate with Cost
  Transparency)](integrate-ct.htm "(Opens in a new tab or window)").
