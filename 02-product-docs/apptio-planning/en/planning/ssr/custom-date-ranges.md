...
breadcrumb: []
source_path: "planning/ssr/custom-date-ranges.html"
images: []
capability_ids: []
...
The Costing & Planning customers can now create multi-year reports using custom date
ranges.
...
1. Open the visualization editor in Apptio BI and select any Planning data source.
...
The following figure shows a sample comparison period selection for a visualization.![Select a Date Range compares January through September of 2021 to January through September 2022.](../../../resources/images/ssr_images/release_notes/bi-ct-customdaterange_722x582.png)
