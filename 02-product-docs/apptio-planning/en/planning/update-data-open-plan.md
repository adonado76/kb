...
breadcrumb: []
source_path: "planning/update-data-open-plan.html"
images: []
capability_ids: []
...
- **Remove update restrictions**
  1. On the Apptio Planning menu, click the
     Settings button (**Add Image (../../resources/images/it
     planning\_images/icon\_gear.png**), then click Company
     Profile.
...
- **Update an open plan**
  ...
  3. Select (**Add Image (../../resources/images/icons/3-dots.pg)**, and then select
     Update Reference Data.

     A dialog displays with information about
     your changes, including line-item deletions.
