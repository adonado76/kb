...
breadcrumb: []
source_path: "planning/bp-handling-labor-compensation.html"
images: []
capability_ids: []
...
reference data](manage-labor-configuration.htm "(Opens in a new tab or window)"). Before recording labor compensation rates, Apptio recommends your
...
labor salary details](restrict-access-labor.htm "(Opens in a new tab or window)"). This is the recommended approach, as this provides the most accuracy
...
respective roles. To learn more, see [Restrict access to labor salary details](restrict-access-labor.htm "(Opens in a new tab or window)").
...
labor salary details](restrict-access-labor.htm "(Opens in a new tab or window)").
...
To know more, see [Setting up labor compensation adjustments](https://help.apptio.com/en-us/it-planning/planning/plan-labor-compensation.htm "(Opens in a new tab or window)").
