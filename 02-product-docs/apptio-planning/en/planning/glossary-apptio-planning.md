...
breadcrumb: []
source_path: "planning/glossary-apptio-planning.html"
images: []
capability_ids: []
...
Actuals Actual costs incurred, per month. See [Import and publish actuals](import-publish-actuals.dita "(Opens in a new tab or window)").
...
up to five levels of approvers. See [Manage Cost Object Permissions reference data](manage-cost-object.dita "(Opens in a new tab or window)").
...
are maintained as reference data. See [Manage Asset reference data](manage-asset-configuration.dita "(Opens in a new tab or window)").
...
as a result, incur cost. See [Forecast indirect service costs](sdp/forecast-indirect-service.dita "(Opens in a new tab or window)").
...
Contract types are maintained as reference data. See [Manage Contract reference data](manage-contract-configuration.dita "(Opens in a new tab or window)").

Cost center A built-in dimension in Reference data that aligns to your Cost Objects in
your budget plan structure. See [Manage dimensions](manage-reference-data.dital "(Opens in a new tab or window)").
...
conversion (FX) rates, against the common currency. See [Support multiple currencies](support-multiple-currencies.dita "(Opens in a new tab or window)").
...
and incorporates prior month actuals, if available. See [Budget planning and forecasting](budget-planning-forecasting.dita "(Opens in a new tab or window)").
...
Labor Resource Pools A group of trained people from which to source staff. In Apptio
planning applications, these are people whose skill set that can be leveraged across various
...
+ Indirect Cost - Charges = Net Expenses). See [View net expenses](view-net-expense.dita "(Opens in a new tab or window)").
...
development, network upgrades, and so forth. See [Project Financial Planning](pfp/gs-project-financial.dita "(Opens in a new tab or window)").

Project Owner Role The owner of a project specified in reference data. The Project Owner
can edit their assigned project budget data. See [Project Financial Planning](pfp/gs-project-financial.dita "(Opens in a new tab or window)").
...
communication services (voice, internet, wifi access). See [Service Demand Planning](sdp/gs-service-demand.dita "(Opens in a new tab or window)").

Service Owner roleThe owner of a service specified in reference data. The Service Owner
can edit their assigned service budget data. See [Forecast demand for services](sdp/forecast-demand-services.dita "(Opens in a new tab or window)").
...
The price group of the consumer determines which price a consumer is charged. See [Edit the Company Profile](edit-company-profile.html).
