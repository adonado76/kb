...
- To open Plans, open the left-hand navigation pane and select Planning > Plans.
  ...
  ![image](../../resources/images/it%20planning_images/plans2_430x128.png)
...
- Select ![more](../../resources/images/it%20planning_images/options1_23x20.png) > Open Show/Hide Columns.
- Select or clear the checkboxes to add or remove columns.

## Create a new plan

1. Select ![add icon](../../resources/images/it%20planning_images/new-plan-icon_19x20.png).
...
4. Return to Plans and confirm that the new plan is now listed as an Active Plan.
   ...
   If Integrated Investment Planning is Enabled, the projects will be copied into the new plan with one of the
...
To view a plan in the Properties pane, select ![view plan](../../resources/images/it%20planning_images/icon-plan-properties_21x20.png).

## Filter plans

To filter the values displayed in a plan column:

1. Hover over the column header and select ![icon](../../resources/images/it%20planning_images/burger-button_13x9.png).
2. Select ![filter icon](../../../../../03-media/apptio-planning/resources/images/icons/icon-filteron_18x20.png) to filter column values.

   Remember: You can also use this pane to:
   - Show and hide columns, by selecting ![column icon](../../../../../03-media/apptio-planning/resources/images/icons/icon-showhide_19x20.png)
   - Freeze and unfreeze columns, by selecting ![unfreeze columns](../../../../../03-media/apptio-planning/resources/images/icons/icon-column-freeze_21x20.png)

   Planning opens the list of filters for you to choose from. By default, (Select All)
   is selected.

   ![image](../../resources/images/it%20planning_images/plan-filter.png)
3. Filter the values to display in the column by doing one of the following:
   ...
   ![image](../../resources/images/it%20planning_images/current-filters.png)

## Clear filters

To clear filters, select ![filter](../../resources/images/it%20planning_images/clear-filters_20x20.png)
above the plan.

## Sort plans by column

- To sort plans by a column, hover over the column header and select ![sort](../../resources/images/it%20planning_images/itfmf-ct_images/sort-icon_21x20.png).
