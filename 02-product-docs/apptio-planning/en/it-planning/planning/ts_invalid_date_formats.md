...
You are unable to import date values into Planning due to invalid
formatting, and are unsure of which date formats are correct.

## What's going on

Planning has stringent requirements for date formatting that are more
specific than other Apptio products.
...
You must use one date format consistently across your entire Planning
project.
...
Planning pulls date format support from your browser or system settings.
Find your browser in the following section, and ensure the browser settings are configured
correctly.
