...
planning and forecasting](budget-planning-forecasting.html).
...
January 2018, February 2018, and March 2018. For more information, see [Import and publish actuals](import-publish-actuals.html).
...
When creating a forecast, note the following and see also [Create a plan or forecast](create-budget-plan.html):
