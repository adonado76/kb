...
|  |  |
| --- | --- |
| camera icon | Watch this video from Apptio Education Services: [Configuring Reference Data: Project Financial Planning Dimensions](https://community.ibm.com/community/user/viewdocument/configuring-reference-data-project?CommunityKey=4100dfb8-fc23-4203-83c7-019253cf7c0b&tab=librarydocuments "(Opens in a new tab or window)"). |
...
dependencies on other dimensions (see [-](../manage-reference-data.html) for more information). You can import dimensions reference data from a .csv file or from
Costing Standard and export dimensions reference data templates and table data (see [Manage dimensions](../manage-reference-data.html "(Opens in a new tab or window)")).
...
4. Select ![more option](../../../../../../03-media/apptio-planning/resources/images/icons/icon-options_23x20.png) > Export.
...
7. Open the downloaded .csv file. Do not change the column headings or data structure of the file.
   ...
   - Currency Code - The common currency for the project. This value is required when support
     ...
     currencies](../support-multiple-currencies.html)). The common currency value should be the three letter ISO code for the currency.
   ...
   - Project Manager - The assigned project manager. Choose from user accounts
     defined via Enhanced Access Administration.
...
8. Save the file in the .csv format. Now, select **Configuration > Reference Data >
   Project**.
9. Select ![more icon](../../../../../../03-media/apptio-planning/resources/images/icons/icon-options_23x20.png) > Import. Drag and drop the file with the data onto the highlighted area of the
   Import File window **> Import**.
10. To publish the changes, select ![more icon](../../../../../../03-media/apptio-planning/resources/images/icons/icon-options_23x20.png) > Publish
    > Publish.
11. To cancel the changes, select ![more icon](../../../../../../03-media/apptio-planning/resources/images/icons/icon-options_23x20.png) > Revert
    > Revert.
...
4. Select ![more icon](../../../../../../03-media/apptio-planning/resources/images/icons/icon-options_23x20.png) > Export.
5. In the Export file window, under Format options, you can change the format of the exported
   data.
6. Select Export. The reference data is exported as a .csv file.
7. Open the downloaded .csv file. Do not change the column headings or data structure of the file.
...
The Activity Types dimension is used by Labor Activity Planning. See
[Early Access feature: Labor activity planning](../labor-activity-planning.html "The Apptio Planning applications 2.45 release of March 20, 2019 introduced an alternative mode for project labor planning called Labor Activity Planning. The Admin or Budget Process Owner can make Labor Activity Planning features visible in the interface.").
This dimension is used to associate Allocation and Demand line items with an Activity Type.
...
The Department Labor Activity Rates dimension is used by Labor Activity
Planning. See [Early Access feature: Labor Activity
Planning](../labor-activity-planning.html "The Apptio Planning applications 2.45 release of March 20, 2019 introduced an alternative mode for project labor planning called Labor Activity Planning. The Admin or Budget Process Owner can make Labor Activity Planning features visible in the interface."). This dimension is used to set a labor rate for specific roles.
...
7. Open the downloaded .csv file. Do not change the column headings or data structure of the file.
   ...
   - Currency - The common currency for labor activity allocation. Required when support for
     multiple currencies is enabled (see [Support for multiple currencies](../support-multiple-currencies.dita "(Opens in a new tab or window)")). The Department's common currency value
...
The Project Labor Activity Rates dimension is used by Labor Activity
Planning. See [Early Access feature: Labor activity
planning](../labor-activity-planning.html "The Apptio Planning applications 2.45 release of March 20, 2019 introduced an alternative mode for project labor planning called Labor Activity Planning. The Admin or Budget Process Owner can make Labor Activity Planning features visible in the interface."). This dimension is used to set a labor rate for specific labor activities.
...
9. Select ![more icon](../../../../../../03-media/apptio-planning/resources/images/icons/icon-options_23x20.png) > Import. Drag and drop the file with the data onto the highlighted area of the
   Import File window **> Import**.
10. To publish the changes, select ![more icon](../../../../../../03-media/apptio-planning/resources/images/icons/icon-options_23x20.png) > Publish > Publish

See [Manage Score Configuration](score-manage.html)
