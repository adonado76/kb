...
title: "Import Reference Data from Apptio Costing"
breadcrumb:
  - "Planning"
  - "Integrations"
...
summary: ""
---
# Import Reference Data from Apptio Costing

Reference Data in Apptio Planning defines the core dimensions used for planning,
forecasting, and reporting, such as Accounts, Cost Centers, Departments, Vendors, Projects, and
Labor Roles. Using Automated Data Management (ADM), you can import trusted, governed reference
data directly from Apptio Costing to ensure consistency across financial workflows.
...
3. Locate the appropriate reference dataset by matching the **Entity Name**.
...
## Import Reference Data into Apptio Planning
...
1. A user updates datasets mapped to reference data entities and performs a Check-in in
   Apptio Costing (Data Studio).
...
4. ADM retrieves the updated reference data from the Costing Staging Environment and
   imports it for use in Apptio Planning.
...
- Reference data imports complete without requiring manual publishing
