...
3. Select ![](../../../../../03-media/apptio-planning/resources/images/icons/3-dots.png) in the top right corner of the
   table, select Export > Export All.
4. Open the downloaded .csv file and update the data values as required:
   - Asset Class - The unique identifier of the Asset class category name
