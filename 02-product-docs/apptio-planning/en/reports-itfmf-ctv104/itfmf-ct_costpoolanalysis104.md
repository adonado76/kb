...
breadcrumb: []
source_path: "reports-itfmf-ctv104/itfmf-ct_costpoolanalysis104.html"
images: []
capability_ids: []
...
![](../../resources/images/it%20planning_images/itfmf-ct_images/itfmf-ct_costpoolanalysis_overview.png)
...
- [Financial Review
  report (v107)](itfmf-ct_financialreview107.html "(Opens in a new tab or window)")
- [Financial
  Review - CapEx report (v107)](itfmf-ct_financialreviewcapexv107.html "(Opens in a new tab or window)")
- [Financial
  Analysis report (v104)](itfmf-ct_financialanalysis104.html "(Opens in a new tab or window)")
...
- Details displays a spreadsheet of the OpEx by cost pool broken out by fixed variable.
  ...
  ![](../../resources/images/it%20planning_images/itfmf-ct_images/itfmf-ct_costpoolanalysis_details.png)
...
- Details - displays a spreadsheet of the OpEx and CapEx by cost pool. Expand any item in
  ...
  ![](../../resources/images/it%20planning_images/itfmf-ct_images/itfmf-ct_costpoolanalysis_details2.png)
...
![](../../resources/images/it%20planning_images/itfmf-ct_images/itfmf-ct_costpoolanalysis_breakout.png)

Then, click an account code to see the transaction details from your financial source of record
(such as your GL).

![](../../resources/images/it%20planning_images/itfmf-ct_images/itfmf-ct_costpoolanalysis_transactiondetails.png)
