...
Você pode usar o painel Rightsizing para visualizar as recomendações de otimização de recursos para Amazon Web Services ( AWS ) Elastic Compute Cloud ( EC2 ). O painel mostra as recomendações de rightsizing e de inatividade (encerramento). Você pode visualizar as recomendações em várias contas a partir de um único painel.
...
Para acessar o painel do AWS EC2, abra a página inicial do Cloudability e, no menu de navegação à esquerda, selecione Otimizar > Redimensionamento. Na página Rightsizing, selecione a guia AWS e, em seguida, selecione a subguia EC2.

![Redimensionamento Captura de tela d AWS EC2](../../../../03-media/cloudability-premium/images/rightsizing-aws-ec2-dashboard.jpg)
...
1. Selecione o ícone de filtro ![ícone do filtro](../../../../03-media/cloudability-premium/images/edit-icon.jpg) .
...
O painel contém uma tabela de recomendações de dimensionamento, que fornece uma visão geral dos recursos do EC2 para os quais foram identificadas recomendações. A tabela inclui as seguintes colunas:
...
- ID do recurso: a ID do recurso EC2.
- Nome do recurso : O nome do recurso EC2.
- Nome da conta : O nome da conta EC2.
- Fonte de dados : A fonte de dados EC2.
- Inativo : O tempo gasto abaixo de 2% da CPU em uma escala de 1 a 100.
- Custo : o custo total de todas as instâncias em execução em EC2.
- Current : O tipo de instância atual do EC2.
- Novo : O tipo de instância EC2 mais recomendado.
...
| Dados utilitários incompletos | Certifique-se de que sua política esteja atualizada com as permissões mais recentes. Caso contrário, determine se o recurso ficou ativo por menos de uma hora, pois ele pode não aparecer no cache do Describe Data em AWS. |
...
![detalhes da recomendação captura de tela do AWS EC2](../../../../03-media/cloudability-premium/images/rightsizing-aws-ec2-details.jpg)
