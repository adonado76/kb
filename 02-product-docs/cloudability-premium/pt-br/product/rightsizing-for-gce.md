...
Você pode usar o painel Rightsizing para visualizar as recomendações de otimização de recursos para recursos de máquinas virtuais do GCE ( Google Compute Engine ). O painel mostra as recomendações de rightsizing e de inatividade (encerramento).

[Rightsizing em Cloudability](get-recommendations-for-scaling-your-cloud-resources-with-rightsizing.html)

Antes de começar

Para visualizar o painel do GCE, certifique-se de que os seguintes requisitos sejam atendidos:
...
Acesse o painel de controle do GCE

Para acessar o painel do GCE, abra a página inicial Cloudability e, no menu de navegação à esquerda, selecione Optimize > Rightsizing. Na página Rightsizing, selecione a guia GCP e, em seguida, selecione a subguia GCE para visualizar as recomendações para Google Compute Engine.
...
O painel contém uma tabela de recomendações de dimensionamento de direitos, que fornece uma visão geral de seus recursos de GCE. A tabela inclui as seguintes colunas:
...
- Nome do recurso : O nome do recurso GCE.
- Nome da conta : O nome da conta GCE.
- Região : A região GCE
...
- Atual :O tipo de recurso GCE atual.
- Atual :O tipo de recurso GCE atual.
- Novo : O tipo de recurso GCE mais recomendado.
