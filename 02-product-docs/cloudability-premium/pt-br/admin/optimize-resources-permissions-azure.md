...
language: "pt-br"
doc_type: "admin"
title: "Referência de permissões de otimização de recursos Microsoft Azure"
breadcrumb:
...
summary: ""
---
# Referência de permissões de otimização de recursos Microsoft Azure

As seguintes permissões de otimização de recursos estão disponíveis para Azure em Cloudability Premium :
