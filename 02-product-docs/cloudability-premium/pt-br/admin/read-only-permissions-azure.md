...
language: "pt-br"
doc_type: "admin"
title: "Referência de permissões somente leitura - Microsoft Azure"
breadcrumb:
  - "Cloudability Premium"
  - "Obtendo dados em Cloudability"
  - "Conectar Microsoft Azure"
  - "Referência de permissões Microsoft Azure"
source_path: "admin/read-only-permissions-azure.html"
images: []
capability_ids: []
last_updated: "2026-06-29"
summary: ""
---
# Referência de permissões somente leitura - Microsoft Azure

As seguintes permissões de somente leitura estão disponíveis para Azure em Cloudability Premium :
...
**Tópico principal:** [Referência de permissões Microsoft Azure](../admin/permissions-reference-azure.html)
