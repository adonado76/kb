...
language: "es"
doc_type: "admin"
title: "Conexión con Azure EA - API de detalles de costes"
breadcrumb:
...
summary: ""
---
# Conexión con Azure EA - API de detalles de costes

**Descripción general**

Esta guía te explica paso a paso cómo conectar de forma segura tu entorno de EA de Azure a IBM Cloudability a través de las API de detalles de costes de Azure.

La API de detalles de costes es un mecanismo alternativo de acreditación para los clientes de Azure. Una vez conectado, podrás acceder a la experiencia « FinOps » en Cloudability. En este proceso, crearemos un «Service Principle» en tu cuenta de Azure, lo que ayudará a Cloudability a obtener los datos de facturación.
...
El proceso de acreditación de la API de « Azure » de Cloudability para consultar los detalles de los costes consta de dos pasos principales:
...
2. **En Cloudability : configurar las credenciales de la cuenta de facturación de Azure**
   ...
   5. Se descargará un script de « PowerShell ».
...
3. **En el portal « Azure »: sube el script « PowerShell »**
   ...
   4. Además, asignará un rol denominado «**Lector** de inscripciones» a la cuenta de facturación que se utiliza para acceder a la API de detalles de costes a través de Cloudability.
...
5. **¿Cuándo debo utilizar la API de detalles de costes de Azure?**
...
7. **¿Cómo puedo migrar de la API de detalles de costes de Azure a las exportaciones de detalles de Azure?**
