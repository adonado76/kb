...
language: "es"
doc_type: "admin"
title: "Estimación de costes basada en el uso y la configuración"
breadcrumb:
...
summary: ""
---
# Estimación de costes basada en el uso y la configuración

Cloudability Governance puede estimar los costes directamente a partir de tu configuración de Terraform. Además de las estimaciones basadas en la configuración, puede proporcionar opcionalmente parámetros de entrada basados en el uso para recursos específicos. Estos datos ayudan a generar proyecciones de costes más precisas y personalizadas basadas en su consumo previsto. En el caso de los servicios que requieren datos de uso —como AWS Lambda, SQS y otros—, se utilizará un valor de uso predeterminado cuando no se introduzca ningún dato personalizado. Si introduces tus propios valores de uso previstos, estos siempre prevalecerán sobre los valores predeterminados.

## Terraform/Terragrunt

**Comunidad Terraform / Acciones de GitHub**

Si utiliza GitHub Actions o la edición Terraform Community:

- Cloudability La gobernanza se activa mediante una acción de Github definida para el repositorio. El uso previsto se puede especificar mediante un archivo usage.json y se puede indicar como entrada en la acción de Github IBM /ibm-cloudability-governance/actions/cost-estimation. Aquí puedes ver un ejemplo: [https://github.com/IBM/ibm-cloudability-governance/blob/main/example-workflows/single-deployment/workflow.yaml#L95](https://github.com/IBM/ibm-cloudability-governance/blob/main/example-workflows/single-deployment/workflow.yaml#L95 "(se abre en una pestaña o una ventana nueva)")

**HCP Terraform / Terraform Enterprise (TFE)**

Si utiliza HCP Terraform / Terraform Enterprise:

- Cloudability La gobernanza se activa mediante una **tarea de ejecución** asociada a un espacio de trabajo específico definido en HCP Terraform.

- Si existe un archivo « usage.json » en el **directorio de trabajo configurado** del espacio de trabajo, Cloudability Governance lo detectará automáticamente y aplicará los valores de uso de dicho archivo durante la estimación de costes.

- El nombre del archivo debe coincidir con el nombre « usage.json ».

Esto garantiza que las entradas basadas en el uso se apliquen de forma coherente siempre que se realice una estimación de costes para ese espacio de trabajo.

**Ejemplo de usage.json**
...
| Clave | Descripción |
| --- | --- |
| Ejemplo: « aws\_instance.costguard\_demo\_ec2\_1 » | Descripción del recurso |
| «os» | Recurso Propiedad |
| «linux\_unix» | El valor que se fija |
...
Las estimaciones se muestran en forma de comentarios PR, lo que permite conocer los costes mensuales en función de las entradas de uso.

## Tipos de servicios compatibles con AWS
...
15. RedShift
16. Cloudwatch
17. Servicio de gestión de claves (KMS)
18. FSx
19. Servicio de migración de bases de datos
20. Sistema de archivos elástico
21. Equilibrio de carga elástico (ELB)
22. OpenSearch
23. Cortafuegos de aplicaciones web (WAF)
24. Glue
25. ECS

## AWS Detalles de consumo por tipo de servicio
...
aws\_fsx\_lustre\_sistema\_de\_archivos
...
sistema\_de\_archivos\_aws\_efs
...
Recursos sin servidor

función\_aws\_lambda
...
aws\_lambda\_configuración\_de\_concurrencia\_provisionada
...
aws\_emr\_aplicación\_sin\_servidor
...
aws\_emrcontainers\_plantilla\_de\_trabajo
...
flota de instancias de AWS EMR
...
Recursos de procesamiento de eventos
...
alarma\_métrica\_aws\_cloudwatch
...
aws\_kms\_réplica\_clave\_externa
...
aws\_vpc\_endpoint (puerta de enlace)
...
Recursos sobre el equilibrio de carga

aws\_elb (Equilibrador de carga clásico)
...
aws\_lb (Equilibrador de carga de aplicaciones)
...
aws\_lb (Equilibrador de carga de red)
...
## Tipos de servicios compatibles con Azure

1. Linux Máquina virtual
2. Máquina virtual de Windows
3. Máquina virtual (heredada)
4. Linux Conjunto de máquinas virtuales
5. Conjunto de máquinas virtuales de Windows
6. Conjunto de máquinas virtuales (heredado)
7. Clúster de Kubernetes
8. Disco gestionado
9. Application Insights
10. Área de trabajo de Log Analytics
11. CosmosDB (SQL, Mongo, Cassandra, Gremlin, Table)
12. Cortafuegos
13. PostgreSQL Servidor flexible
14. MySQL Servidor flexible
15. Aplicación Function (para Linux y Windows)
16. Configuración de autoescalado

## Azure Detalles de consumo por tipo de servicio

Recursos informáticos

azurerm\_máquina\_virtual, azurerm\_máquina\_virtual\_linux, azurerm\_máquina\_virtual\_windows
...
azurerm\_monitor\_autoscale\_setting (para conjuntos de máquinas virtuales escalables)
