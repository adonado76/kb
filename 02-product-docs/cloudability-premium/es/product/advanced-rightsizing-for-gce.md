...
Puede utilizar el panel de control de ajuste avanzado para ver las recomendaciones de optimización de recursos para los recursos de máquinas virtuales de GCE ( Google Compute Engine ). El panel de control muestra recomendaciones de optimización tanto para ahorros como para inversiones, impulsadas por un motor de optimización de cartera ( Turbonomic ). Puede ver las recomendaciones de varias cuentas de Azure desde un único panel de control.

[Redimensionamiento avanzado en Cloudability Premium](advanced-rightsizing-powered-by-turbonomic.html)

Antes de empezar

Para ver el panel de control de GCE, asegúrese de haber conectado Cloudability a las cuentas correctas de GCP.
...
Para acceder al panel de control de GCE, abra la página de inicio de Cloudability y, en el menú de navegación de la izquierda, seleccione Optimizar > Redimensionamiento > Avanzado. En la página Rightsizing, seleccione la pestaña « GCP » y, a continuación, seleccione la subpestaña «GCE ».
...
El panel de control contiene una tabla de recomendaciones de redimensionamiento, que ofrece una visión general de los recursos de GCE para los que se han identificado recomendaciones. La tabla incluye las siguientes columnas:
