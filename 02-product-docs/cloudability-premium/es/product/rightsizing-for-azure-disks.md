...
Puede utilizar el Rightsizing dashboard para ver las recomendaciones de optimización de recursos para Azure Disk. El cuadro de mandos muestra tanto las recomendaciones de ampliación como las de inactividad (finalización). Puede ver las recomendaciones en varias cuentas desde un único panel de control.

[Redimensionamiento en Cloudability](get-recommendations-for-scaling-your-cloud-resources-with-rightsizing.html)

Antes de empezar

Para ver el panel de Azure Disk, asegúrese de que ha conectado Cloudability a las cuentas correctas de Azure.

[Conectar Microsoft Azure](../admin/azure-cm-setup.html)

Acceda al panel Azure Disk

Para acceder al panel de control de Azure Disk, abra la página de inicio de Cloudability y, en el menú de navegación de la izquierda, seleccione Optimize > Rightsizing. En la página Redimensionamiento, seleccione la pestaña Azure y, a continuación, seleccione la subpestaña Disco.

![Icono Notas](../../../../03-media/cloudability-premium/images/azure-disk-1.jpg)

Personalizar el salpicadero

Puedes configurar las siguientes opciones para personalizar tu panel de control.

Sólo se admite la Base de Costes Bajo Demanda para Disco.
...
El panel de control contiene una tabla de recomendaciones de dimensionamiento, que proporciona una visión general de sus recursos de disco Azure. La tabla incluye las siguientes columnas:
...
- Nombre del recurso : El nombre del recurso de disco
- Nombre de cuenta : El nombre de la cuenta Azure.
- Grupo de recursos : El grupo de recursos al que pertenece el volumen.
- Ralentí : El porcentaje de horas con cero IOPS.
- Estado : El estado del disco.
- Coste : El coste total del recursodisco para la línea temporal seleccionada.
- Tipo : El tipo de recurso de disco actual.
- Tamaño : El tamaño del recurso (en GiB ).
- Nuevo tipo : El tipo de recurso de disco más recomendado.
- Nuevo tamaño : El tamaño máximo recomendado para los recursos de disco (en GiB ).
...
- Ahorro de costes : El importe estimado de ahorro de costes a 10 o 30 días.
...
![Icono Notas](../../../../03-media/cloudability-premium/images/azure-disk-2.jpg)
