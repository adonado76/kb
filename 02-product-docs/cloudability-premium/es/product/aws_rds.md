...
**Accede al panel de control de « AWS RDS »**

Para acceder al panel de control de « AWS RDS », abre la página de inicio de Cloudability y, en el menú de navegación de la izquierda, selecciona «Optimizar» > «Rightsizing» > «Avanzado». En la página «Rightsizing», selecciona la pestaña « AWS » y, a continuación, selecciona « RDS » en el menú desplegable. ![](../../../../03-media/cloudability-premium/images/aws-rds-dashboard.png)
...
Nota: En el caso de « RDS », el coste viene determinado por el uso de la instancia.
...
- **Nombre del recurso** : El nombre del recurso « RDS »
- **Nombre de la cuenta** : nombre de la cuenta en la que se ejecuta la base de datos « RDS »
...
- **Tipo** : El tipo de instancia actual de « RDS »
- **Coste** : el coste actual de la instancia de RDS
- **Nuevo tipo de instancia** : el tipo de instancia recomendado para « RDS »
- **Nuevo coste** : El coste previsto del nuevo tipo de instancia « RDS » recomendado
...
| **Escala** | Cambia el tamaño según el tipo de recurso especificado en **la** columna «Nuevo tipo de instancia». Esta acción puede consistir en un «aumento» o una «reducción» de la capacidad, en función de las políticas configuradas |
...
Para consultar las descripciones de las dimensiones y métricas de costes, véase [el](glossary-of-cost-dimensions-and-metrics.dita "(se abre en una pestaña o una ventana nueva)") «Glosario de dimensiones y métricas de costes»

Para consultar los detalles de la dimensión y las métricas de utilización, véase [el](glossary-of-utilization-dimensions-and-metrics.dita "(se abre en una pestaña o una ventana nueva)") «Glosario de dimensiones y métricas de utilización»
