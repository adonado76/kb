...
Puede utilizar el Rightsizing dashboard para ver las recomendaciones de optimización de recursos para Microsoft Azure Compute. El cuadro de mandos muestra tanto las recomendaciones de ampliación como las de inactividad (finalización). Puede ver las recomendaciones en varias cuentas desde un único panel de control.

[Redimensionamiento en Cloudability](get-recommendations-for-scaling-your-cloud-resources-with-rightsizing.html)

Antes de empezar

Para ver el panel Azure Compute, asegúrese de que ha conectado Cloudability a las cuentas Azure correctas.

[Conectar Microsoft Azure](../admin/azure-cm-setup.html)

Acceda al panel Azure Compute

Para acceder al panel de control de Azure Compute, abra la página de inicio de Cloudability y, en el menú de navegación de la izquierda, seleccione Optimize > Rightsizing. En la página Redimensionamiento, seleccione la pestaña Azure y, a continuación, seleccione la subpestaña Computación.

![Captura de pantalla del ajuste de la capacidad de Azure Compute](../../../../03-media/cloudability-premium/images/azure-compute-1.jpg)
...
El panel contiene una tabla de recomendaciones de dimensionamiento, que proporciona una visión general de los recursos informáticos para los que se han identificado recomendaciones. La tabla incluye las siguientes columnas:
...
- Nombre del recurso : Nombre del recurso informático.
- Nombre de la cuenta : El nombre de la cuenta de Compute.
- Grupo de recursos : El grupo de recursos Compute.
- Fuente de datos : La fuente de datos Compute.
- Ralentí : El tiempo transcurrido por debajo del 2% de CPU en una escala de 1-100.
- Coste: El coste total de todas las instancias en ejecución en Compute.
- Actual : El tipo de instancia Compute actual.
- Nuevo : El tipo de instancia Compute más recomendado.
...
![Captura de pantalla con los detalles de la recomendación de Azure](../../../../03-media/cloudability-premium/images/azure-compute-2.jpg)
