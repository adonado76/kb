...
Puede utilizar el panel de control de ajuste avanzado para ver las recomendaciones de optimización de recursos para Amazon Web Services ( AWS ) Elastic Compute Cloud ( EC2 ). El panel de control muestra recomendaciones de optimización tanto para ahorros como para inversiones, impulsadas por un motor de optimización de cartera ( Turbonomic ). Puede ver las recomendaciones de varias cuentas de AWS desde un único panel de control.
...
Para acceder al panel de control de AWS EC2, abra la página de inicio de Cloudability y, en el menú de navegación de la izquierda, seleccione Optimizar > Redimensionamiento > Avanzado. En la página Rightsizing, seleccione la pestaña « AWS » (Redesignos de procesos) y, a continuación, seleccione la subpestaña « EC2 » (Redesignos de procesos).
...
En el caso de EC2, el gasto se determina en función del uso de la instancia.

Tabla de recomendaciones de redimensionamiento

El panel de control contiene una tabla de recomendaciones de redimensionamiento, que ofrece una visión general de los recursos de EC2 para los que se han identificado recomendaciones. La tabla incluye las siguientes columnas:
...
- Nombre de la cuenta : El nombre de la cuenta de EC2
...
- Tipo : El tipo de instancia actual de EC2
- **Coste** : el coste actual de la instancia EC2
- Nuevo tipo de instancia : el tipo de instancia recomendado EC2
- Nuevo coste : el coste previsto del nuevo tipo de instancia recomendado EC2
...
Cuando recomendamos cambiar un tipo de instancia EC2 a una instancia sin almacenamiento local, incluimos en la recomendación que añada EBS y tenga en cuenta ambos en el ahorro.
...
Para ver los detalles de la dimensión y las métricas de utilización, consulte  [Glosario de dimensiones y métricas de utilización](glossary-of-utilization-dimensions-and-metrics.html)
