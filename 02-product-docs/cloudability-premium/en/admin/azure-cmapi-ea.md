...
This guide walks you through the process of securely connecting your Azure EA environment to IBM
...
2. **In Cloudability - Configure Credentials for Azure Billing Account**
   ...
   5. A PowerShell Script will be downloaded.
...
3. **In Azure Portal - Upload the PowerShell script** 
   ...
   4. It will also assign a role called as **Enrollment reader** to the billing account which is
      used to access the Cost Details API by Cloudability.
