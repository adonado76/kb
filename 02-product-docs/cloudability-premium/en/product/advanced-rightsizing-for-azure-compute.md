...
for Microsoft Azure Compute. The dashboard shows optimization recommendations for both savings and
...
To access the Microsoft Azure Compute dashboard, open the Cloudability home page, and from the
left navigation menu, select  Optimize > Rightsizing > Advanced. On the Rightsizing
page, select the Azure tab, and then select the Compute subtab.
...
- Resource Name : The virtual machine name
...
- Type : The current virtual machine instance type
- **Cost** : The current virtual machine instance cost
- New Instance Type : The recommended virtual machine instance type
- New Cost : The projected cost of the new virtual machine instance type
  recommended
