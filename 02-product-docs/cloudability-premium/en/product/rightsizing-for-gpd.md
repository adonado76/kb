...
To access the GPD dashboard, open the
Cloudability
home page, and from the left navigation menu, select
...
GPD
sub tab to view recommendations for Google Persistent Disk.

![gpd dashboard screenshot](../../../../03-media/cloudability-premium/images/rightsizing-gcp-gpd.jpg)
...
Current
column and the resource recommended in the
New
column based purely on
On-Demand Pricing
. It does not include any potential impact from Committed Use Discounts.
...
- State : The state can be  Attached  , 
  Unattached  , or  Deleted .
...
![recommendation details screenshot](../../../../03-media/cloudability-premium/images/rightsizing-gcp-gpd-details.jpg)
