...
[Connecting with AWS - Customer Integration Guide](../admin/aws-credentialing-premium-home.dita "(Opens in a new tab or window)")
...
To access the AWS RDS dashboard, open the Cloudability home page, and from the left
navigation menu, select Optimize > Rightsizing > Advanced. On the Rightsizing page, select
the AWS tab, and then select RDS from the dropdown.

![](../../../../03-media/cloudability-premium/images/aws-rds-dashboard.png)
...
Note: For RDS, spend is determined by instance usage.
...
- **Resource Name**: The RDS resource name
- **Account Name**: Account name where the RDS Database is running
...
- **Type** : The current RDS instance type
- **Cost** : The current RDS instance cost
- **New Instance Type**: The recommended RDS instance type
- **New Cost**: The projected cost of the new RDS instance type recommended
...
To view descriptions of the cost dimensions
and metrics, refer to [Glossary of cost dimensions and metrics](glossary-of-cost-dimensions-and-metrics.dita "(Opens in a new tab or window)")

To view details of the utilization dimension and metrics, refer to [Glossary
of utilization dimensions and metrics](glossary-of-utilization-dimensions-and-metrics.dita "(Opens in a new tab or window)")
