...
practice: "tbm"
language: "en"
doc_type: "boit-components.html"
title: "Billing Standard components"
breadcrumb: []
source_path: "boit-components.html"
images: []
capability_ids: []
...
- Billing Standard - Servers(optional) - The 
  Servers component gives the IT Service Provider and Business Consumer insight into the
