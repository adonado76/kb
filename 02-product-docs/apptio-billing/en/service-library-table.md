...
practice: "tbm"
language: "en"
doc_type: "service-library-table.html"
title: "Add data to the Service Library table"
breadcrumb: []
source_path: "service-library-table.html"
images: []
capability_ids: []
...
Library table. See [Upload a data file](../studio/data_studio/upload-data-file.html) for more information.
...
directly into Service Library; instead, append only the raw file. See [Append data](../studio/data_studio/append-data.html) for more
information .
...
- Pricing Methodology - The approach used when calculating he Billing
  Standard showback or chargeback values.
