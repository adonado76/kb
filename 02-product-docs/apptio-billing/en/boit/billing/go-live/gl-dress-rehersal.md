...
A dress rehearsal is a full end-to-end run in **Development** and verified in
**Staging** that mimics what you will be published into Production.
...
- Full Billing runs for in Development:
  - Core PxQ calculation.
  - Any domain-specific models in scope (for example, cloud, projects,
    applications).
- Report validation in Development:
  - Invoice/summary views.
  - Detail/drill-down views.
  - Journals and exports.
- QA checks in Staging:
  - Structural, volume, and rate checks.
  - Reconciliation to Costing where applicable.
...
- Sign-offs from:
  - Admin/Analyst (technical validity).
  - Finance (if chargeback/journals are in scope).
  - One or two key Service or Product Owners.
