...
practice: "tbm"
language: "en"
doc_type: "maintain-the-data.html"
title: "Maintain the data"
breadcrumb: []
source_path: "maintain-the-data.html"
images: []
capability_ids: []
...
existing table in Billing Standard . For more information, see  [Append data](../studio/data_studio/append-data.html)  .
