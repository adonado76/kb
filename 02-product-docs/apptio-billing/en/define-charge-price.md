...
practice: "tbm"
language: "en"
doc_type: "define-charge-price.html"
title: "Define the Charge Price x Quantity relationship"
breadcrumb: []
source_path: "define-charge-price.html"
images: []
capability_ids: []
...
3. In the Service Library table, set the Pricing Methodology to
   Cost for all services that will use Cost to determine the charge.
...
2. In the Service Library table, set the Pricing Methodology to
   Budget for all services that will use Cost to determine the charge.
...
3. In the Service Library table, set the Pricing Methodology to
   Price for all services that will use (Price x Quantity) to determine the charge.
4. In the Project Explorer , click the Model step
